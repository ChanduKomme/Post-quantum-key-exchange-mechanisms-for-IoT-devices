# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 2
...
# 30 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/aes.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 31 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/aes.h" 2
...
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 2
...
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 2
# 56 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr.h" 1
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr.h"
static inline void mbedtls_ctr_increment_counter(uint8_t n[16])
{


    for (int i = 3;; i--) {
        uint32_t x = ((0) ? mbedtls_get_unaligned_uint32((n) + (i << 2)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((n) + (i << 2))) );
        x += 1;
        { if (0) { mbedtls_put_unaligned_uint32((n) + (i << 2), (uint32_t) (x)); } else { mbedtls_put_unaligned_uint32((n) + (i << 2), __builtin_bswap32((uint32_t) (x))); } };
        if (x != 0 || i == 0) {
            break;
        }
    }
}
# 57 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 2
# 78 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
__attribute__((unused)) static const unsigned char FSb[256] =
{
...
__attribute__((unused)) static const unsigned char RSb[256] =
{
...
__attribute__((unused)) static const uint32_t round_constants[10] =
{
    0x00000001, 0x00000002, 0x00000004, 0x00000008,
    0x00000010, 0x00000020, 0x00000040, 0x00000080,
    0x0000001B, 0x00000036
};
# 492 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
void mbedtls_aes_init(mbedtls_aes_context *ctx)
{
...
{
    if (ctx == 
# 499 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c" 3 4
              ((void *)0)
# 499 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
                  ) {
        return;
    }
...
# 535 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
__attribute__((unused)) static unsigned mbedtls_aes_rk_offset(uint32_t *buf)
{
# 566 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    (void) buf;
...
# 597 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    ctx->rk_offset = mbedtls_aes_rk_offset(ctx->buf);
    RK = ctx->buf + ctx->rk_offset;
# 613 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    for (unsigned int i = 0; i < (keybits >> 5); i++) {
        RK[i] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (i << 2))) : mbedtls_get_unaligned_uint32((key) + (i << 2)) );
    }
        ...
        case 10:
            ...
            for (unsigned int i = 0; i < 10; i++, RK += 4) {
                RK[4] = RK[0] ^ round_constants[i] ^
                         ((uint32_t) FSb[((uint8_t) (((RK[3]) >> 8) & 0xff))]) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[3]) >> 16) & 0xff))] << 8) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[3]) >> 24) & 0xff))] << 16) ^
                         ((uint32_t) FSb[((uint8_t) ((RK[3]) & 0xff))] << 24);
        ...
        case 12:
            ...
            for (unsigned int i = 0; i < 8; i++, RK += 6) {
                RK[6] = RK[0] ^ round_constants[i] ^
                         ((uint32_t) FSb[((uint8_t) (((RK[5]) >> 8) & 0xff))]) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[5]) >> 16) & 0xff))] << 8) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[5]) >> 24) & 0xff))] << 16) ^
                         ((uint32_t) FSb[((uint8_t) ((RK[5]) & 0xff))] << 24);
        ...
        case 14:
            ...
            for (unsigned int i = 0; i < 7; i++, RK += 8) {
                RK[8] = RK[0] ^ round_constants[i] ^
                         ((uint32_t) FSb[((uint8_t) (((RK[7]) >> 8) & 0xff))]) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[7]) >> 16) & 0xff))] << 8) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[7]) >> 24) & 0xff))] << 16) ^
                         ((uint32_t) FSb[((uint8_t) ((RK[7]) & 0xff))] << 24);
                ...
                RK[12] = RK[4] ^
                         ((uint32_t) FSb[((uint8_t) ((RK[11]) & 0xff))]) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[11]) >> 8) & 0xff))] << 8) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[11]) >> 16) & 0xff))] << 16) ^
                         ((uint32_t) FSb[((uint8_t) (((RK[11]) >> 24) & 0xff))] << 24);
                           ...
                           unsigned int keybits)
{
    ...
    ctx->nr = cty.nr;
# 729 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    ...
    *RK++ = *SK++;
    ...
    for (int i = ctx->nr - 1; i > 0; i--, SK -= 8) {
        for (int j = 0; j < 4; j++, SK++) {
            *RK++ = RT0[FSb[((uint8_t) ((*SK) & 0xff))]] ^
                    ((uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 8) & 0xff))]]) << 8) + (uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 8) & 0xff))]]) >> 24)) ^
                    ((uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 16) & 0xff))]]) << 16) + (uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 16) & 0xff))]]) >> 16)) ^
                    ((uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 24) & 0xff))]]) << 24) + (uint32_t) ((RT0[FSb[((uint8_t) (((*SK) >> 24) & 0xff))]]) >> 8));
        }
    }
...
# 883 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
int mbedtls_internal_aes_encrypt(mbedtls_aes_context *ctx,
                                 const unsigned char input[16],
                                 unsigned char output[16])
{
    ...
    t.X[0] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (0))) : mbedtls_get_unaligned_uint32((input) + (0)) ); t.X[0] ^= *RK++;
    t.X[1] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (4))) : mbedtls_get_unaligned_uint32((input) + (4)) ); t.X[1] ^= *RK++;
    t.X[2] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (8))) : mbedtls_get_unaligned_uint32((input) + (8)) ); t.X[2] ^= *RK++;
    t.X[3] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (12))) : mbedtls_get_unaligned_uint32((input) + (12)) ); t.X[3] ^= *RK++;

    for (i = (ctx->nr >> 1) - 1; i > 0; i--) {
        do { (t.Y[0]) = *RK++ ^ FT0[((uint8_t) ((t.X[0]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) >> 8)); (t.Y[1]) = *RK++ ^ FT0[((uint8_t) ((t.X[1]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) >> 8)); (t.Y[2]) = *RK++ ^ FT0[((uint8_t) ((t.X[2]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) >> 8)); (t.Y[3]) = *RK++ ^ FT0[((uint8_t) ((t.X[3]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) >> 8)); } while (0);
        do { (t.X[0]) = *RK++ ^ FT0[((uint8_t) ((t.Y[0]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 24) & 0xff))]) >> 8)); (t.X[1]) = *RK++ ^ FT0[((uint8_t) ((t.Y[1]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 24) & 0xff))]) >> 8)); (t.X[2]) = *RK++ ^ FT0[((uint8_t) ((t.Y[2]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.Y[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 24) & 0xff))]) >> 8)); (t.X[3]) = *RK++ ^ FT0[((uint8_t) ((t.Y[3]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.Y[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.Y[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.Y[2]) >> 24) & 0xff))]) >> 8)); } while (0);
    }

    do { (t.Y[0]) = *RK++ ^ FT0[((uint8_t) ((t.X[0]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) >> 8)); (t.Y[1]) = *RK++ ^ FT0[((uint8_t) ((t.X[1]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) >> 8)); (t.Y[2]) = *RK++ ^ FT0[((uint8_t) ((t.X[2]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) >> 8)); (t.Y[3]) = *RK++ ^ FT0[((uint8_t) ((t.X[3]) & 0xff))] ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((FT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((FT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((FT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) >> 8)); } while (0);

    t.X[0] = *RK++ ^
             ((uint32_t) FSb[((uint8_t) ((t.Y[0]) & 0xff))]) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[1]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[2]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[3]) >> 24) & 0xff))] << 24);

    t.X[1] = *RK++ ^
             ((uint32_t) FSb[((uint8_t) ((t.Y[1]) & 0xff))]) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[2]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[3]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[0]) >> 24) & 0xff))] << 24);

    t.X[2] = *RK++ ^
             ((uint32_t) FSb[((uint8_t) ((t.Y[2]) & 0xff))]) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[3]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[0]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[1]) >> 24) & 0xff))] << 24);

    t.X[3] = *RK++ ^
             ((uint32_t) FSb[((uint8_t) ((t.Y[3]) & 0xff))]) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[0]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[1]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) FSb[((uint8_t) (((t.Y[2]) >> 24) & 0xff))] << 24);

    { if (0) { mbedtls_put_unaligned_uint32((output) + (0), __builtin_bswap32((uint32_t) (t.X[0]))); } else { mbedtls_put_unaligned_uint32((output) + (0), ((uint32_t) (t.X[0]))); } };
    { if (0) { mbedtls_put_unaligned_uint32((output) + (4), __builtin_bswap32((uint32_t) (t.X[1]))); } else { mbedtls_put_unaligned_uint32((output) + (4), ((uint32_t) (t.X[1]))); } };
    { if (0) { mbedtls_put_unaligned_uint32((output) + (8), __builtin_bswap32((uint32_t) (t.X[2]))); } else { mbedtls_put_unaligned_uint32((output) + (8), ((uint32_t) (t.X[2]))); } };
    { if (0) { mbedtls_put_unaligned_uint32((output) + (12), __builtin_bswap32((uint32_t) (t.X[3]))); } else { mbedtls_put_unaligned_uint32((output) + (12), ((uint32_t) (t.X[3]))); } };
                                 ...
                                 unsigned char output[16])
{
    ...
    for (i = (ctx->nr >> 1) - 1; i > 0; i--) {
        do { (t.Y[0]) = *RK++ ^ RT0[((uint8_t) ((t.X[0]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) >> 8)); (t.Y[1]) = *RK++ ^ RT0[((uint8_t) ((t.X[1]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) >> 8)); (t.Y[2]) = *RK++ ^ RT0[((uint8_t) ((t.X[2]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) >> 8)); (t.Y[3]) = *RK++ ^ RT0[((uint8_t) ((t.X[3]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) >> 8)); } while (0);
        do { (t.X[0]) = *RK++ ^ RT0[((uint8_t) ((t.Y[0]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 24) & 0xff))]) >> 8)); (t.X[1]) = *RK++ ^ RT0[((uint8_t) ((t.Y[1]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 24) & 0xff))]) >> 8)); (t.X[2]) = *RK++ ^ RT0[((uint8_t) ((t.Y[2]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.Y[3]) >> 24) & 0xff))]) >> 8)); (t.X[3]) = *RK++ ^ RT0[((uint8_t) ((t.Y[3]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.Y[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.Y[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.Y[0]) >> 24) & 0xff))]) >> 8)); } while (0);
    }

    do { (t.Y[0]) = *RK++ ^ RT0[((uint8_t) ((t.X[0]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 24) & 0xff))]) >> 8)); (t.Y[1]) = *RK++ ^ RT0[((uint8_t) ((t.X[1]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 24) & 0xff))]) >> 8)); (t.Y[2]) = *RK++ ^ RT0[((uint8_t) ((t.X[2]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[3]) >> 24) & 0xff))]) >> 8)); (t.Y[3]) = *RK++ ^ RT0[((uint8_t) ((t.X[3]) & 0xff))] ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) << 8) + (uint32_t) ((RT0[((uint8_t) (((t.X[2]) >> 8) & 0xff))]) >> 24)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) << 16) + (uint32_t) ((RT0[((uint8_t) (((t.X[1]) >> 16) & 0xff))]) >> 16)) ^ ((uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) << 24) + (uint32_t) ((RT0[((uint8_t) (((t.X[0]) >> 24) & 0xff))]) >> 8)); } while (0);

    t.X[0] = *RK++ ^
             ((uint32_t) RSb[((uint8_t) ((t.Y[0]) & 0xff))]) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[3]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[2]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[1]) >> 24) & 0xff))] << 24);

    t.X[1] = *RK++ ^
             ((uint32_t) RSb[((uint8_t) ((t.Y[1]) & 0xff))]) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[0]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[3]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[2]) >> 24) & 0xff))] << 24);

    t.X[2] = *RK++ ^
             ((uint32_t) RSb[((uint8_t) ((t.Y[2]) & 0xff))]) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[1]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[0]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[3]) >> 24) & 0xff))] << 24);

    t.X[3] = *RK++ ^
             ((uint32_t) RSb[((uint8_t) ((t.Y[3]) & 0xff))]) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[2]) >> 8) & 0xff))] << 8) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[1]) >> 16) & 0xff))] << 16) ^
             ((uint32_t) RSb[((uint8_t) (((t.Y[0]) >> 24) & 0xff))] << 24);
...
# 1010 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
__attribute__((unused)) static void aes_maybe_realign(mbedtls_aes_context *ctx)
{
...
# 1057 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    if (mode == 0) {
...
# 1107 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
# 1292 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
int mbedtls_aes_crypt_cfb128(mbedtls_aes_context *ctx,
                             int mode,
                             size_t length,
                             size_t *iv_off,
                             ...
                             unsigned char *output)
{
    ...
    if (mode == 0) {
        while (length--) {
            if (n == 0) {
                ret = mbedtls_aes_crypt_ecb(ctx, 1, iv, iv);
                if (ret != 0) {
                    goto exit;
                }
            }
                          ...
                          unsigned char *output)
{
    ...
    for (size_t i = 0; i < length;) {
        size_t n = 16;
        if (offset == 0) {
            ret = mbedtls_aes_crypt_ecb(ctx, 1, nonce_counter, stream_block);
            if (ret != 0) {
                goto exit;
            }
...
# 1493 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
# 1550 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
# 1620 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
# 1691 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
...
{ 16, 32, 36 };
# 1817 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
int mbedtls_aes_self_test(int verbose)
{
    ...
    if (verbose != 0) {
# 1873 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
        {

            printf("  AES note: built-in implementation.\n");
...

    {
        ...
        for (i = 0; i < num_tests << 1; i++) {
            ...
            if (verbose != 0) {
                printf("  AES-ECB-%3u (%s): ", keybits,
                               (mode == 0) ? "dec" : "enc");
            }
# 1906 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
            memset(buf, 0, 16);
...

    {
        ...
        for (i = 0; i < num_tests << 1; i++) {
            ...
            if (verbose != 0) {
                printf("  AES-CFB128-%3u (%s): ", keybits,
                               (mode == 0) ? "dec" : "enc");
            }
...
# 2280 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/aes.c"
    ret = 0;
