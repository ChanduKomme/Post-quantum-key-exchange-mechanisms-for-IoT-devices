# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
...
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
...
# 11 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64_internal.h" 1
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 2
                          ...
                          const unsigned char *src, size_t slen)
{
    ...
    if (n > (0xffffffffU 
# 76 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
                     - 1) / 4) {
        *olen = 0xffffffffU
# 77 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
                       ;
        return -0x002A;
    }
    ...
    if ((dlen < n + 1) || (
# 83 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 3 4
                          ((void *)0) 
# 83 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
                               == dst)) {
        *olen = n + 1;
        return -0x002A;
    }
...
# 209 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
    *olen = (n / 4) * 3 - equals;
# 220 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
    if ((*olen != 0 && dst == 
# 220 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c" 3 4
                             ((void *)0)
# 220 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/base64.c"
                                 ) || dlen < *olen) {
        return -0x002A;
    ...
    if (accumulated_digits == 3) {
        *p++ = ((uint8_t) (((x << 6) >> 16) & 0xff));
        *p++ = ((uint8_t) (((x << 6) >> 8) & 0xff));
    } else if (accumulated_digits == 2) {
        *p++ = ((uint8_t) (((x << 12) >> 16) & 0xff));
    }
