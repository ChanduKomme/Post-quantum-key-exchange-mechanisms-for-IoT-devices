# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
...
# 10 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
...
psa_status_t mbedtls_psa_aead_abort(
    mbedtls_psa_aead_operation_t *operation);
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
...
psa_status_t mbedtls_psa_cipher_decrypt(const psa_key_attributes_t *attributes,
                                        ...
                                        size_t output_size,
                                        size_t *output_length);
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
...
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 2
    ...
    psa_algorithm_t alg)
{
    ...
    switch ((((alg) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000)))) {
        ...
        case (((((psa_algorithm_t) 0x05500100)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000))):
            operation->alg = ((psa_algorithm_t) 0x05500100);



            if ((((attributes->type) & ((psa_key_type_t) 0x7000)) == ((psa_key_type_t) 0x2000) ? 1u << (((attributes->type) >> 8) & 7) : 0u) != 16) {
        ...
        case (((((psa_algorithm_t) 0x05500200)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000))):
            operation->alg = ((psa_algorithm_t) 0x05500200);
            ...
            break;
# 104 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
        default:
            (void) status;
            (void) key_buffer;
    ...
    operation->tag_length = (((alg) & ((psa_algorithm_t) 0x003f0000)) >> 16);
...
{
    psa_status_t status = ((psa_status_t)-151);
    mbedtls_psa_aead_operation_t operation = { 0, 0, 0, 0, { 0 } };
    uint8_t *tag;
    ...
    if (operation.alg == ((psa_algorithm_t) 0x05500100)) {
        status = mbedtls_to_psa_error(
    ...
    if (operation.alg == ((psa_algorithm_t) 0x05500200)) {
        status = mbedtls_to_psa_error(
...
# 186 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) tag;
        (void) nonce;
        (void) nonce_length;
    ...
    uint8_t *plaintext, size_t plaintext_size, size_t *plaintext_length)
{
    ...
    mbedtls_psa_aead_operation_t operation = { 0, 0, 0, 0, { 0 } };
    const uint8_t *tag = 
# 240 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c" 3 4
                        ((void *)0)
# 240 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
                            ;
...
# 297 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) nonce;
        (void) nonce_length;
        (void) additional_data;
...
# 408 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) operation;
        (void) nonce;
        (void) nonce_length;
...
# 471 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) operation;
        (void) input;
        (void) input_length;
...
# 532 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) operation;
        (void) input;
        (void) output;
...
# 601 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_aead.c"
    {
        (void) ciphertext;
