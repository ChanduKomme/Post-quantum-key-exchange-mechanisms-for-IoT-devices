# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/nist_kw.h" 1
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/nist_kw.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 26 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/nist_kw.h" 2
...
int mbedtls_cipher_auth_decrypt_ext(mbedtls_cipher_context_t *ctx,
                                    ...
                                    unsigned char *output, size_t output_len,
                                    size_t *olen, size_t tag_len);
# 30 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/nist_kw.h" 2
...
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2
...
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2
...
int mbedtls_ct_memcmp(const void *a,
                      const void *b,
                      size_t n);
# 26 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2
...
# 27 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2
...
# 32 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 2
                           ...
                           const int is_wrap)
{
    ...
    cipher_info = mbedtls_cipher_info_from_values(cipher,
                                                  ...
                                                  MBEDTLS_MODE_ECB);
    if (cipher_info == 
# 63 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 3 4
                      ((void *)0)
# 63 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
                          ) {
        return -0x6100;
    }
...
# 80 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
...
{
    if (ctx == 
# 105 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 3 4
              ((void *)0)
# 105 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
                  ) {
        return;
    }
...
static void calc_a_xor_t(unsigned char A[8], uint64_t t)
{
    size_t i = 0;
                         ...
                         unsigned char *output, size_t *out_len, size_t out_size)
{
    ...
    uint64_t t = 0;
    unsigned char outbuff[8 * 2];
    unsigned char inbuff[8 * 2];
    ...
    *out_len = 0;
    ...
    if (mode == MBEDTLS_KW_MODE_KW) {
        ...
        memcpy(output, NIST_KW_ICV1, 8);
        memmove(output + 8, input, in_len);
    } else {
        if (in_len % 8 != 0) {
            padlen = (8 - (in_len % 8));
        }

        if (out_size < in_len + 8 + padlen) {
            return -0x6100;
        }
        ...
        memcpy(output, NIST_KW_ICV2, 8 / 2);
        { if (0) { mbedtls_put_unaligned_uint32((output) + (8 / 2), (uint32_t) ((in_len & 0xffffffff))); } else { mbedtls_put_unaligned_uint32((output) + (8 / 2), __builtin_bswap32((uint32_t) ((in_len & 0xffffffff)))); } }
                                                      ;

        memcpy(output + 8, input, in_len);
        memset(output + 8 + in_len, 0, padlen);
    }
    semiblocks = ((in_len + padlen) / 8) + 1;
    ...
    if (mode == MBEDTLS_KW_MODE_KWP
        ...
        for (t = 1; t <= s; t++) {
            ...
            memcpy(R2, outbuff + 8, 8);
            R2 += 8;
            if (R2 >= output + (semiblocks * 8)) {
                R2 = output + 8;
            }
        }
    }

    *out_len = semiblocks * 8;

cleanup:

    if (ret != 0) {
        memset(output, 0, semiblocks * 8);
    }
    mbedtls_platform_zeroize(inbuff, 8 * 2);
    mbedtls_platform_zeroize(outbuff, 8 * 2);

    return ret;
}
# 260 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
                  ...
                  unsigned char *output, size_t *out_len)
{
    ...
    unsigned char inbuff[8 * 2];
    unsigned char *R = 
# 271 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c" 3 4
                      ((void *)0)
# 271 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
                          ;
    *out_len = 0;
    ...
    memcpy(A, input, 8);
    memmove(output, input + 8, (semiblocks - 1) * 8);
    R = output + (semiblocks - 2) * 8;
    ...
    *out_len = (semiblocks - 1) * 8;

cleanup:
    if (ret != 0) {
        memset(output, 0, (semiblocks - 1) * 8);
    }
                           ...
                           unsigned char *output, size_t *out_len, size_t out_size)
{
    ...
    *out_len = 0;
    ...
    if (mode == MBEDTLS_KW_MODE_KW) {
        ...
        diff = mbedtls_ct_memcmp(NIST_KW_ICV1, A, 8);
        ...
        diff = mbedtls_ct_memcmp(NIST_KW_ICV2, A, 8 / 2);

        if (diff != 0) {
            ret = -0x6300;
        }

        Plen = ((0) ? mbedtls_get_unaligned_uint32((A) + (8 / 2)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((A) + (8 / 2))) );
...
# 460 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/nist_kw.c"
...
int mbedtls_nist_kw_self_test(int verbose)
{
...

    {
        ...
        for (i = 0; i < num_tests; i++) {
            if (verbose != 0) {
                printf("  KW-AES-%u ", (unsigned int) key_len[i] * 8);
            }
...

    {
        ...
        for (i = 0; i < num_tests; i++) {
            olen = sizeof(out);
            if (verbose != 0) {
                printf("  KWP-AES-%u ", (unsigned int) key_len[i] * 8);
            }
