# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/x509_crl.h" 1
# 12 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/x509_crl.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/x509_crl.h" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/x509_crl.h" 2
...
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2
...
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2
...
# 26 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2
# 34 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
...
# 35 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 2
# 51 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                                ...
                                int *ver)
{
    ...
    if ((ret = mbedtls_asn1_get_int(p, end, ver)) != 0) {
        ...
        return mbedtls_error_add(-0x2200, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 63);
    }

    return 0;
}
# 76 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                            ...
                            mbedtls_x509_buf *ext)
{
    ...
    while (*p < end) {
        ...
        if ((ret = mbedtls_asn1_get_tag(p, end, &len,
                                        0x20 | 0x10)) != 0) {
            return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 110);
        }
        ...
        if ((ret = mbedtls_asn1_get_tag(p, end_ext_data, &len,
                                        0x06)) != 0) {
            return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 118);
        }
        *p += len;
        ...
        if ((ret = mbedtls_asn1_get_bool(p, end_ext_data,
                                         &is_critical)) != 0 &&
            (ret != -0x0062)) {
            return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 126);
        }


        if ((ret = mbedtls_asn1_get_tag(p, end_ext_data, &len,
                                        0x04)) != 0) {
            return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 132);
        }


        *p += len;
        if (*p != end_ext_data) {
            return mbedtls_error_add(-0x2500, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 138)
                                                                      ;
        }


        if (is_critical) {
            return mbedtls_error_add(-0x2500, -0x0062, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 144)
                                                                     ;
        }
    }

    if (*p != end) {
        return mbedtls_error_add(-0x2500, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 150)
                                                                  ;
    }
                                  ...
                                  mbedtls_x509_buf *ext)
{
    ...
    if ((ret = mbedtls_asn1_get_tag(p, end, &ext->len,
        ...
        if (ret == -0x0062) {
            ext->p = 
# 182 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                    ((void *)0)
# 182 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                        ;
            return 0;
        }
        return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 185);
    }

    end = *p + ext->len;

    if (end != *p + ext->len) {
        return mbedtls_error_add(-0x2500, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 191)
                                                                  ;
    }
    ...
    while (*p < end) {
        if ((ret = mbedtls_asn1_get_tag(p, end, &len,
                                        0x20 | 0x10)) != 0) {
            return mbedtls_error_add(-0x2500, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 198);
        }
    ...
    if (*p != end) {
        return mbedtls_error_add(-0x2500, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 205)
                                                                  ;
    }
                            ...
                            mbedtls_x509_crl_entry *entry)
{
    ...
    while (*p < end) {
        ...
        if (*p < end) {
            ...
            if (cur_entry->next == 
# 269 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                                  ((void *)0)
# 269 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                                      ) {
                return -0x2880;
            }
                               ...
                               const unsigned char *buf, size_t buflen)
{
    ...
    size_t len;
    unsigned char *p = 
# 288 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                      ((void *)0)
# 288 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                          , *end = 
# 288 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                                   ((void *)0)
# 288 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
    ...
    if (crl == 
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
              ((void *)0) 
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                   || buf == 
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                             ((void *)0)
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
...
# 306 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                                            ((void *)0)
# 306 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                                                ) {
        crl = crl->next;
    }

    if (crl->version != 0 && crl->next == 
# 310 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                                         ((void *)0)
# 310 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                                             ) {
        crl->next = calloc(1, sizeof(mbedtls_x509_crl));

        if (crl->next == 
# 313 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                        ((void *)0)
# 313 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                            ) {
    ...
    p = calloc(1, buflen);
    if (p == 
# 330 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
            ((void *)0)
# 330 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                ) {
        return -0x2880;
    }
    ...
    if (len != (size_t) (end - p)) {
        mbedtls_x509_crl_free(crl);
        return mbedtls_error_add(-0x2180, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 355)
                                                                  ;
    }
    ...
    if ((ret = mbedtls_asn1_get_tag(&p, end, &len,
                                    0x20 | 0x10)) != 0) {
        mbedtls_x509_crl_free(crl);
        return mbedtls_error_add(-0x2180, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 367);
    }
    ...
    if ((ret = mbedtls_asn1_get_tag(&p, end, &len,
                                    0x20 | 0x10)) != 0) {
        mbedtls_x509_crl_free(crl);
        return mbedtls_error_add(-0x2180, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 407);
    }
    ...
    if ((ret = mbedtls_x509_get_time(&p, end, &crl->next_update)) != 0) {
        if (ret != (mbedtls_error_add(-0x2400, -0x0062, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 427)
                                                                      ) &&
            ret != (mbedtls_error_add(-0x2400, -0x0060, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 429)
                                                                   )) {
            mbedtls_x509_crl_free(crl);
            return ret;
        }
    }
# 444 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
    ...
    if (p != end) {
        mbedtls_x509_crl_free(crl);
        return mbedtls_error_add(-0x2180, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 464)
                                                                  ;
    }
    ...
    if (p != end) {
        mbedtls_x509_crl_free(crl);
        return mbedtls_error_add(-0x2180, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c", 495)
                                                                  ;
    }
...
int mbedtls_x509_crl_parse(mbedtls_x509_crl *chain, const unsigned char *buf, size_t buflen)
{
# 560 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
    return mbedtls_x509_crl_parse_der(chain, buf, buflen);
}
# 594 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
int mbedtls_x509_crl_info(char *buf, size_t size, const char *prefix,
                          const mbedtls_x509_crl *crl)
{
    int ret = -0x006E;
    ...
    while (entry != 
# 634 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                   ((void *)0) 
# 634 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                        && entry->raw.len != 0) {
        ret = snprintf(p, n, "\n%sserial number: ",
                               prefix);
        do { if (ret < 0 || (size_t) ret >= n) return -0x2980; n -= (size_t) ret; p += (size_t) ret; } while (0);
...
void mbedtls_x509_crl_free(mbedtls_x509_crl *crl)
{
    ...
    while (crl_cur != 
# 684 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                     ((void *)0)
# 684 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                         ) {
        ...
        while (entry_cur != 
# 692 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                           ((void *)0)
# 692 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                               ) {
            entry_prv = entry_cur;
        ...
        if (crl_cur->raw.p != 
# 699 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c" 3 4
                             ((void *)0)
# 699 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/x509_crl.c"
                                 ) {
