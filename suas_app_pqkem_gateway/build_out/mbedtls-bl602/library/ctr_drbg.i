# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 2
...
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 2
# 33 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 34 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 2
# 73 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
void mbedtls_ctr_drbg_init(mbedtls_ctr_drbg_context *ctx)
{
...
{
    if (ctx == 
# 95 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 3 4
              ((void *)0)
# 95 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                  ) {
        return;
    }
# 108 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                                   ...
                                   size_t len)
{
    ...
    if (ctx->f_entropy != 
# 132 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 3 4
                         ((void *)0)
# 132 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                             ) {
        return -0x0034;
    }
    ...
    if (len > 0x7fffffff
# 143 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                    ) {
        return -0x0038;
    }
                           ...
                           const unsigned char *data, size_t data_len)
{
    ...
    unsigned char *p, *iv;
    int ret = 0;
# 179 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
    mbedtls_aes_context aes_ctx;
    ...
    memset(buf, 0, 384 +
           16 + 16);
# 199 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
    p = buf + 16;
    { if (0) { mbedtls_put_unaligned_uint32((p) + (0), (uint32_t) (data_len)); } else { mbedtls_put_unaligned_uint32((p) + (0), __builtin_bswap32((uint32_t) (data_len))); } };
    p += 4 + 3;
    *p++ = (32 + 16);
...
# 219 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
    ...
    for (j = 0; j < (32 + 16); j += 16) {
        ...
        while (use_len > 0) {
            mbedtls_xor(chain, chain, p, 16);
            p += 16;
            use_len -= (use_len >= 16) ?
                       16 : use_len;
# 249 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 276 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
    ...
    for (j = 0; j < (32 + 16); j += 16) {
# 293 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
        if ((ret = mbedtls_aes_crypt_ecb(&aes_ctx, 1,
                                         iv, iv)) != 0) {
            goto exit;
        }
...
# 332 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 363 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
    ...
    mbedtls_xor(tmp, tmp, data, (32 + 16));
# 386 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 411 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
int mbedtls_ctr_drbg_update(mbedtls_ctr_drbg_context *ctx,
                            const unsigned char *additional,
                            size_t add_len)
{
...
# 447 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                                            ...
                                            size_t nonce_len)
{
    ...
    if (additional != 
# 483 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 3 4
                     ((void *)0) 
# 483 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                          && len != 0) {
...
# 535 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
int mbedtls_ctr_drbg_seed(mbedtls_ctr_drbg_context *ctx,
                          int (*f_entropy)(void *, unsigned char *, size_t),
                          void *p_entropy,
                          const unsigned char *custom,
...
# 576 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 609 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
int mbedtls_ctr_drbg_random_with_add(void *p_rng,
                                     unsigned char *output, size_t output_len,
                                     const unsigned char *additional, size_t add_len)
{
    ...
    memset(locals.add_input, 0, (32 + 16));
    ...
    while (output_len > 0) {
        ...
        mbedtls_ctr_increment_counter(ctx->counter);
# 669 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
        if ((ret = mbedtls_aes_crypt_ecb(&ctx->aes_ctx, 1,
...
# 708 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 3 4
                                                                   ((void *)0)
# 708 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
                                                                       , 0);
...
# 866 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
...
# 949 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
int mbedtls_ctr_drbg_self_test(int verbose)
{
    ...
    mbedtls_ctr_drbg_set_nonce_len(&ctx, 32 / 2);
    if ((mbedtls_ctr_drbg_seed(&ctx, ctr_drbg_self_test_entropy, (void *) entropy_source_pr, pers_pr, 32)) != 0) { if (verbose != 0) printf("failed\n"); return 1; }


                                                                 ;
    mbedtls_ctr_drbg_set_prediction_resistance(&ctx, 1);
    if ((mbedtls_ctr_drbg_random(&ctx, buf, 64)) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    if ((mbedtls_ctr_drbg_random(&ctx, buf, sizeof(result_pr))) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    if ((memcmp(buf, result_pr, sizeof(result_pr))) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    ...
    mbedtls_ctr_drbg_set_entropy_len(&ctx, 32);
    mbedtls_ctr_drbg_set_nonce_len(&ctx, 32 / 2);
    if ((mbedtls_ctr_drbg_seed(&ctx, ctr_drbg_self_test_entropy, (void *) entropy_source_nopr, pers_nopr, 32)) != 0) { if (verbose != 0) printf("failed\n"); return 1; }


                                                                   ;
    if ((mbedtls_ctr_drbg_reseed(&ctx, 
# 997 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c" 3 4
   ((void *)0)
# 997 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ctr_drbg.c"
   , 0)) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    if ((mbedtls_ctr_drbg_random(&ctx, buf, 64)) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    if ((mbedtls_ctr_drbg_random(&ctx, buf, sizeof(result_nopr))) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
    if ((memcmp(buf, result_nopr, sizeof(result_nopr))) != 0) { if (verbose != 0) printf("failed\n"); return 1; };
