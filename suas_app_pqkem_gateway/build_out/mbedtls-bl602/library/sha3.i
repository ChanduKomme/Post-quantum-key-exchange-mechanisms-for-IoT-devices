# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
...
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 2
# 44 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha3.h" 1
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha3.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha3.h" 2
...
# 45 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 2
...
# 46 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 2
...
# 47 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 2
...
# 52 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 2
# 76 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
static const uint8_t iota_r_packed[24] = {
    (0 << 6 | 0 << 5 | 0 << 4) | 0x01, (0 << 6 | 0 << 5 | 1 << 4) | 0x82, (1 << 6 | 0 << 5 | 1 << 4) | 0x8a, (1 << 6 | 1 << 5 | 1 << 4) | 0x00,
    (0 << 6 | 0 << 5 | 1 << 4) | 0x8b, (0 << 6 | 1 << 5 | 0 << 4) | 0x01, (1 << 6 | 1 << 5 | 1 << 4) | 0x81, (1 << 6 | 0 << 5 | 1 << 4) | 0x09,
    (0 << 6 | 0 << 5 | 0 << 4) | 0x8a, (0 << 6 | 0 << 5 | 0 << 4) | 0x88, (0 << 6 | 1 << 5 | 1 << 4) | 0x09, (0 << 6 | 1 << 5 | 0 << 4) | 0x0a,
    (0 << 6 | 1 << 5 | 1 << 4) | 0x8b, (1 << 6 | 0 << 5 | 0 << 4) | 0x8b, (1 << 6 | 0 << 5 | 1 << 4) | 0x89, (1 << 6 | 0 << 5 | 1 << 4) | 0x03,
    (1 << 6 | 0 << 5 | 1 << 4) | 0x02, (1 << 6 | 0 << 5 | 0 << 4) | 0x80, (0 << 6 | 0 << 5 | 1 << 4) | 0x0a, (1 << 6 | 1 << 5 | 0 << 4) | 0x0a,
    (1 << 6 | 1 << 5 | 1 << 4) | 0x81, (1 << 6 | 0 << 5 | 1 << 4) | 0x80, (0 << 6 | 1 << 5 | 0 << 4) | 0x01, (1 << 6 | 1 << 5 | 1 << 4) | 0x08,
};
...
# 101 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
static void keccak_f1600(mbedtls_sha3_context *ctx)
{
    ...
    for (int round = 0; round < 24; round++) {
        ...
        for (i = 0; i < 5; i++) {
            t = lane[(i + 4) % 5] ^ (((lane[(i + 1) % 5]) << (64U - (63))) | ((lane[(i + 1) % 5]) >> (63)));
            s[i] ^= t; s[i + 5] ^= t; s[i + 10] ^= t; s[i + 15] ^= t; s[i + 20] ^= t;
        }
# 143 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
        for (i = 1; i < 25; i += 4) {
            ...
            s[i + 0] = (((s[i + 0]) << (64U - (((uint8_t) (((r) >> 24) & 0xff))))) | ((s[i + 0]) >> (((uint8_t) (((r) >> 24) & 0xff)))));
            s[i + 1] = (((s[i + 1]) << (64U - (((uint8_t) (((r) >> 16) & 0xff))))) | ((s[i + 1]) >> (((uint8_t) (((r) >> 16) & 0xff)))));
            s[i + 2] = (((s[i + 2]) << (64U - (((uint8_t) (((r) >> 8) & 0xff))))) | ((s[i + 2]) >> (((uint8_t) (((r) >> 8) & 0xff)))));
            s[i + 3] = (((s[i + 3]) << (64U - (((uint8_t) ((r) & 0xff))))) | ((s[i + 3]) >> (((uint8_t) ((r) & 0xff)))));

        }


        t = s[1];
# 170 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
        uint32_t p = pi[0];
        do { uint64_t tmp = (s[((uint8_t) ((p) & 0xff))]); (s[((uint8_t) ((p) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 8) & 0xff))]); (s[((uint8_t) (((p) >> 8) & 0xff))]) = (t); (t) = tmp; } while (0);
        do { uint64_t tmp = (s[((uint8_t) (((p) >> 16) & 0xff))]); (s[((uint8_t) (((p) >> 16) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 24) & 0xff))]); (s[((uint8_t) (((p) >> 24) & 0xff))]) = (t); (t) = tmp; } while (0);
        p = pi[1];
        do { uint64_t tmp = (s[((uint8_t) ((p) & 0xff))]); (s[((uint8_t) ((p) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 8) & 0xff))]); (s[((uint8_t) (((p) >> 8) & 0xff))]) = (t); (t) = tmp; } while (0);
        do { uint64_t tmp = (s[((uint8_t) (((p) >> 16) & 0xff))]); (s[((uint8_t) (((p) >> 16) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 24) & 0xff))]); (s[((uint8_t) (((p) >> 24) & 0xff))]) = (t); (t) = tmp; } while (0);
        p = pi[2];
        ...
        do { uint64_t tmp = (s[((uint8_t) ((p) & 0xff))]); (s[((uint8_t) ((p) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 8) & 0xff))]); (s[((uint8_t) (((p) >> 8) & 0xff))]) = (t); (t) = tmp; } while (0);
        do { uint64_t tmp = (s[((uint8_t) (((p) >> 16) & 0xff))]); (s[((uint8_t) (((p) >> 16) & 0xff))]) = (t); (t) = tmp; } while (0); do { uint64_t tmp = (s[((uint8_t) (((p) >> 24) & 0xff))]); (s[((uint8_t) (((p) >> 24) & 0xff))]) = (t); (t) = tmp; } while (0);
# 202 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
...
{
    if (ctx == 
# 254 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c" 3 4
              ((void *)0)
# 254 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha3.c"
                  ) {
        return;
    }
    ...
    if (ilen >= 8) {
        ...
        if (align_bytes) {
            for (; align_bytes > 0; align_bytes--) {
                do { ctx->state[(ctx->index) >> 3] ^= ((uint64_t) (*input++)) << (((ctx->index) & 0x7) << 3); } while (0);
                ilen--;
                ctx->index++;
            }
        ...
        while (ilen >= 8) {
            do { ctx->state[(ctx->index) >> 3] ^= ((uint64_t) (((0) ? __builtin_bswap64(mbedtls_get_unaligned_uint64((input) + (0))) : mbedtls_get_unaligned_uint64((input) + (0)) ))) << (((ctx->index) & 0x7) << 3); } while (0);
            input += 8;
            ilen -= 8;
                        ...
                        uint8_t *output, size_t olen)
{
    ...
    do { ctx->state[(ctx->index) >> 3] ^= ((uint64_t) (0x6)) << (((ctx->index) & 0x7) << 3); } while (0);
    do { ctx->state[(ctx->max_block_size - 1) >> 3] ^= ((uint64_t) (0x80)) << (((ctx->max_block_size - 1) & 0x7) << 3); } while (0);
    keccak_f1600(ctx);
    ctx->index = 0;

    while (olen-- > 0) {
        *output++ = ((uint8_t) (ctx->state[(ctx->index) >> 3] >> (((ctx->index) & 0x7) << 3)));
                                      ...
                                      mbedtls_sha3_id id)
{
    ...
    if (verbose != 0) {
        printf("  %s long KAT test ", type_name);
    }
