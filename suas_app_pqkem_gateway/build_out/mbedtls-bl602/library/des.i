# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/des.h" 1
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/des.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/des.h" 2
...
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/des.h" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 2
...
# 20 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 2
...
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 2
...
# 265 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
void mbedtls_des_init(mbedtls_des_context *ctx)
{
...
{
    if (ctx == 
# 272 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 3 4
              ((void *)0)
# 272 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
                  ) {
        return;
    }
...
{
    if (ctx == 
# 286 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c" 3 4
              ((void *)0)
# 286 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
                  ) {
        return;
    }
...
# 360 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
...
void mbedtls_des_setkey(uint32_t SK[32], const unsigned char key[8])
{
    ...
    X = ((0) ? mbedtls_get_unaligned_uint32((key) + (0)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (0))) );
    Y = ((0) ? mbedtls_get_unaligned_uint32((key) + (4)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (4))) );
                          ...
                          unsigned char output[8])
{
    ...
    X = ((0) ? mbedtls_get_unaligned_uint32((input) + (0)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (0))) );
    Y = ((0) ? mbedtls_get_unaligned_uint32((input) + (4)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((input) + (4))) );
    ...
    { if (0) { mbedtls_put_unaligned_uint32((output) + (0), (uint32_t) (Y)); } else { mbedtls_put_unaligned_uint32((output) + (0), __builtin_bswap32((uint32_t) (Y))); } };
    { if (0) { mbedtls_put_unaligned_uint32((output) + (4), (uint32_t) (X)); } else { mbedtls_put_unaligned_uint32((output) + (4), __builtin_bswap32((uint32_t) (X))); } };
...
# 784 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/des.c"
