# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ccm.h" 1
# 37 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ccm.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 38 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ccm.h" 2
...
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 2
...
int mbedtls_ct_memcmp(const void *a,
                      const void *b,
                      size_t n);
# 25 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 2
# 33 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
...
# 34 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 2
# 47 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
void mbedtls_ccm_init(mbedtls_ccm_context *ctx)
{
...
{
    int ret = -0x006E;
# 70 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
    const mbedtls_cipher_info_t *cipher_info;

    cipher_info = mbedtls_cipher_info_from_values(cipher, keybits,
                                                  MBEDTLS_MODE_ECB);
    if (cipher_info == 
# 74 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 3 4
                      ((void *)0)
# 74 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
                          ) {
        return -0x000D;
    }
...
{
    if (ctx == 
# 102 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 3 4
              ((void *)0)
# 102 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
                  ) {
        return;
    }
...
# 123 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
...
static int ccm_calculate_first_block_if_ready(mbedtls_ccm_context *ctx)
{
    ...
    if (!(ctx->state & (1 << 0)) || !(ctx->state & (1 << 1))) {
        return 0;
    }
...
# 196 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
    ctx->y[0] |= (ctx->add_len > 0) << 6;
    ctx->y[0] |= ((ctx->tag_len - 2) / 2) << 3;
    ctx->y[0] |= ctx->q - 1;

    for (i = 0, len_left = ctx->plaintext_len; i < ctx->q; i++, len_left >>= 8) {
        ctx->y[15-i] = ((uint8_t) ((len_left) & 0xff));
    }
...
# 246 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
    memset(ctx->ctr, 0, 16);
    ctx->ctr[0] = ctx->q - 1;
                       ...
                       unsigned char *tag, size_t tag_len)
{
    ...
    if (ctx->add_len > 0 && !(ctx->state & (1 << 3))) {
        return -0x000D;
    }
    ...
    if (tag != 
# 502 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c" 3 4
              ((void *)0)
# 502 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
                  ) {
...
int mbedtls_ccm_star_encrypt_and_tag(mbedtls_ccm_context *ctx, size_t length,
                                     ...
                                     unsigned char *tag, size_t tag_len)
{
    return ccm_auth_crypt(ctx, 3, length, iv, iv_len,
...
int mbedtls_ccm_encrypt_and_tag(mbedtls_ccm_context *ctx, size_t length,
                                ...
                                unsigned char *tag, size_t tag_len)
{
    return ccm_auth_crypt(ctx, 1, length, iv, iv_len,
                          add, add_len, input, output, tag, tag_len);
}
...
int mbedtls_ccm_star_auth_decrypt(mbedtls_ccm_context *ctx, size_t length,
                                  ...
                                  const unsigned char *tag, size_t tag_len)
{
    return ccm_auth_decrypt(ctx, 2, length,
                            iv, iv_len, add, add_len,
...
int mbedtls_ccm_auth_decrypt(mbedtls_ccm_context *ctx, size_t length,
                             ...
                             const unsigned char *tag, size_t tag_len)
{
    return ccm_auth_decrypt(ctx, 0, length,
                            iv, iv_len, add, add_len,
                            input, output, tag, tag_len);
}
# 643 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ccm.c"
...
static const unsigned char msg_test_data[24] = {
...
static const unsigned char res_test_data[3][32] = {
