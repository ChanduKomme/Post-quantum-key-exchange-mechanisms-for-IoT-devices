# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
...
# 10 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data(mbedtls_asn1_named_data **list,
                                                       ...
                                                       size_t val_len);
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/psa/crypto_sizes.h" 1
# 38 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/psa/crypto_sizes.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/psa/build_info.h" 1
# 39 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/psa/crypto_sizes.h" 2
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
# 39 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/psa/crypto_driver_common.h"
typedef enum {
...
# 20 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
# 37 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
...
# 38 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
# 45 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
# 50 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c" 2
...
{
    { ((psa_status_t)0), 0 },
    { ((psa_status_t)-134), -0x5080 },
    { ((psa_status_t)-135), -0x5100 },
    { ((psa_status_t)-141), -0x5180 }
};
# 98 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
const mbedtls_error_pair_t psa_to_pk_rsa_errors[] =
{
    { ((psa_status_t)0), 0 },
    { ((psa_status_t)-133), -0x4080 },
    { ((psa_status_t)-135), -0x4080 },
    { ((psa_status_t)-136), -0x4080 },
    { ((psa_status_t)-138), -0x4400 },
    { ((psa_status_t)-148), -0x4480 },
    { ((psa_status_t)-149), -0x4380 },
    { ((psa_status_t)-150), -0x4100 }
};
# 125 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
int psa_generic_status_to_mbedtls(psa_status_t status)
{
    switch (status) {
        case ((psa_status_t)0):
            return 0;
        case ((psa_status_t)-134):
            return -0x0072;
        case ((psa_status_t)-151):
            return -0x006E;
        case ((psa_status_t)-145):
        case ((psa_status_t)-147):
            return -0x0070;
        case ((psa_status_t)-133):
        default:
            return -0x0001;
    }
}
...
{
    switch (status) {
        case ((psa_status_t)-136):
            return -0x3D00;
        case ((psa_status_t)-138):
            return -0x3880;
        case ((psa_status_t)-134):
            return -0x3980;
        case ((psa_status_t)-135):
            return -0x3A80;
        case ((psa_status_t)-133):
            return -0x3F00;
        case ((psa_status_t)-141):
            return -0x3F80;
        case ((psa_status_t)-137):
            return -0x3E80;
        case ((psa_status_t)-152):
        case ((psa_status_t)-153):
        case ((psa_status_t)-146):
            return -0x3E00;
        default:
...
# 348 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
int mbedtls_psa_get_random(void *p_rng,
                           unsigned char *output,
                           size_t output_size)
{
...
# 390 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
                                         ...
                                         unsigned char *der_buf_end)
{
    ...
    do { if ((ret = (mbedtls_asn1_write_len(&p, der_buf_start, len))) < 0) return ret; else (len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(&p, der_buf_start, 0x02))) < 0) return ret; else (len) += ret; } while (0);
...
int mbedtls_ecdsa_raw_to_der(size_t bits, const unsigned char *raw, size_t raw_len,
                             unsigned char *der, size_t der_size, size_t *der_len)
{
    unsigned char r[(((521u) + 7u) / 8u)];
    unsigned char s[(((521u) + 7u) / 8u)];
    const size_t coordinate_len = (((bits) + 7u) / 8u);
    size_t len = 0;
    ...
    do { if ((ret = (mbedtls_asn1_write_len(&p, der, len))) < 0) return ret; else (len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(&p, der, 0x20 | 0x10))) < 0) return ret; else (len) += ret; } while (0)
...
# 510 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_util.c"
...
int mbedtls_ecdsa_der_to_raw(size_t bits, const unsigned char *der, size_t der_len,
                             unsigned char *raw, size_t raw_size, size_t *raw_len)
{
    unsigned char raw_tmp[((((521u) + 7u) / 8u) * 2u)];
    unsigned char *p = (unsigned char *) der;
    size_t data_len;
    size_t coordinate_size = (((bits) + 7u) / 8u);
    int ret;
