...
.Ltext0:
	...
	.file 0 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_gateway/build_out/hal_drv" "/home/chandu/sdk/bl602_iot_sdk/components/hal_drv/bl602_hal/hal_sys.c"
...
hal_reboot:
.LFB8:
	.file 1 "/home/chandu/sdk/bl602_iot_sdk/components/hal_drv/bl602_hal/hal_sys.c"
	.loc 1 37 1
	.cfi_startproc
	addi	sp,sp,-16
...
.LFB12:
	...
	.cfi_def_cfa 8, 0
	.loc 1 59 15
	lui	a5,%hi(__global_pointer_head$)
	addi	a5,a5,%lo(__global_pointer_head$)
	sw	a5,-20(s0)
	.loc 1 62 5
	lui	a5,%hi(.LC0)
	addi	a0,a5,%lo(.LC0)
	...
	li	a1,0
	lui	a5,%hi(__global_pointer_head$)
	addi	a0,a5,%lo(__global_pointer_head$)
	call	memset
	.loc 1 66 21
	lw	a5,-20(s0)
	addi	a5,a5,1116
...
.LFB13:
	...
	.loc 1 84 42
	lw	a5,-20(s0)
	lui	a4,%hi(interrupt_entry)
	addi	a4,a4,%lo(interrupt_entry)
	sw	a4,4(a5)
	.loc 1 85 35
	lw	a5,-20(s0)
	lui	a4,%hi(sprintf)
	addi	a4,a4,%lo(sprintf)
	sw	a4,20(a5)
	.loc 1 86 38
	lw	a5,-20(s0)
	lui	a4,%hi(memcpy)
	addi	a4,a4,%lo(memcpy)
	sw	a4,28(a5)
	.loc 1 87 38
	lw	a5,-20(s0)
	lui	a4,%hi(strlen)
	addi	a4,a4,%lo(strlen)
	sw	a4,36(a5)
	.loc 1 88 38
	lw	a5,-20(s0)
	lui	a4,%hi(memset)
	addi	a4,a4,%lo(memset)
	sw	a4,40(a5)
	.loc 1 89 42
	lw	a5,-20(s0)
	lui	a4,%hi(exception_entry)
	addi	a4,a4,%lo(exception_entry)
	sw	a4,48(a5)
	.loc 1 90 38
	lw	a5,-20(s0)
	lui	a4,%hi(strcpy)
	addi	a4,a4,%lo(strcpy)
	sw	a4,52(a5)
	.loc 1 91 35
	lw	a5,-20(s0)
	lui	a4,%hi(__freertos_irq_stack_top)
	addi	a4,a4,%lo(__freertos_irq_stack_top)
	sw	a4,56(a5)
	.loc 1 92 31
	lw	a5,-20(s0)
	lui	a4,%hi(user_clz)
	addi	a4,a4,%lo(user_clz)
	sw	a4,44(a5)
	.loc 1 93 1
	nop
	lw	ra,28(sp)
...
.LVL0:
	.loc 1 101 22
	lui	a5,%hi(capin_static.1)
	lbu	a4,-17(s0)
	sb	a4,%lo(capin_static.1)(a5)
	.loc 1 102 23
	lui	a5,%hi(capout_static.0)
	lbu	a4,-18(s0)
	sb	a4,%lo(capout_static.0)(a5)
	j	.L11
.L10:
	.loc 1 104 82
	li	a5,553717760
	...
	mv	a3,a5
	lui	a5,%hi(capin_static.1)
	lbu	a4,%lo(capin_static.1)(a5)
	lui	a5,%hi(capout_static.0)
	lbu	a5,%lo(capout_static.0)(a5)
	mv	a1,a5
	mv	a0,a4
	jalr	a3
.LVL1:
...
.Letext0:
	...
	.file 6 "/home/chandu/sdk/bl602_iot_sdk/components/hal_drv/bl602_hal/hal_sys.h"
	...
	.file 9 "/home/chandu/sdk/bl602_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_aon.h"
	.file 10 "/home/chandu/sdk/bl602_iot_sdk/components/hal_drv/bl602_hal/bl_sys.h"
...
.LASF0:
	.string	"/home/chandu/sdk/bl602_iot_sdk/components/hal_drv/bl602_hal/hal_sys.c"
	.globl	__clzsi2
