# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/gcm.h" 1
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/gcm.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/gcm.h" 2
...
int mbedtls_cipher_auth_decrypt_ext(mbedtls_cipher_context_t *ctx,
                                    ...
                                    unsigned char *output, size_t output_len,
                                    size_t *olen, size_t tag_len);
# 26 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/gcm.h" 2
...
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 2
...
# 26 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 2
...
int mbedtls_ct_memcmp(const void *a,
                      const void *b,
                      size_t n);
# 27 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 2
# 53 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
void mbedtls_gcm_init(mbedtls_gcm_context *ctx)
{
...
static inline void gcm_set_acceleration(mbedtls_gcm_context *ctx)
{
    ...
    ctx->acceleration = 1;
# 78 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
}
...
static inline void gcm_gen_table_rightshift(uint64_t dst[2], const uint64_t src[2])
{
    ...
    { if (0) { mbedtls_put_unaligned_uint64((&dst[1]) + (0), (uint64_t) (((0) ? mbedtls_get_unaligned_uint64((&src[1]) + (0)) : __builtin_bswap64(mbedtls_get_unaligned_uint64((&src[1]) + (0))) ) >> 1)); } else { mbedtls_put_unaligned_uint64((&dst[1]) + (0), __builtin_bswap64((uint64_t) (((0) ? mbedtls_get_unaligned_uint64((&src[1]) + (0)) : __builtin_bswap64(mbedtls_get_unaligned_uint64((&src[1]) + (0))) ) >> 1))); } };
    u8Dst[8] |= (u8Src[7] & 0x01) << 7;
    { if (0) { mbedtls_put_unaligned_uint64((&dst[0]) + (0), (uint64_t) (((0) ? mbedtls_get_unaligned_uint64((&src[0]) + (0)) : __builtin_bswap64(mbedtls_get_unaligned_uint64((&src[0]) + (0))) ) >> 1)); } else { mbedtls_put_unaligned_uint64((&dst[0]) + (0), __builtin_bswap64((uint64_t) (((0) ? mbedtls_get_unaligned_uint64((&src[0]) + (0)) : __builtin_bswap64(mbedtls_get_unaligned_uint64((&src[0]) + (0))) ) >> 1))); } };
    u8Dst[0] ^= (u8Src[15] & 0x01) ? 0xE1 : 0;
}
# 99 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
static int gcm_gen_table(mbedtls_gcm_context *ctx)
{
    ...
    ctx->H[256/2][0] = u64h[0];
    ctx->H[256/2][1] = u64h[1];

    switch (ctx->acceleration) {
# 132 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
        default:
...
# 149 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
            for (i = 2; i < 256; i <<= 1) {
                for (j = 1; j < i; j++) {
...
# 184 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
    const mbedtls_cipher_info_t *cipher_info;

    cipher_info = mbedtls_cipher_info_from_values(cipher, keybits,
                                                  MBEDTLS_MODE_ECB);
    if (cipher_info == 
# 188 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 3 4
                      ((void *)0)
# 188 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
                          ) {
        return -0x0014;
    }
...
static void gcm_mult_largetable(uint8_t *output, const uint8_t *x, uint64_t H[256][2])
{
    ...
    if (0) {
        for (i = 15; i > 0; i--) {
            ...
            u16z[0] ^= ((0) ? __builtin_bswap16(mbedtls_get_unaligned_uint16((&last8[rem]) + (0))) : mbedtls_get_unaligned_uint16((&last8[rem]) + (0)) );
        }
    } else {
        for (i = 15; i > 0; i--) {
            mbedtls_xor_no_simd(u8z, u8z, (uint8_t *) H[x[i]], 16);
...
# 347 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
static void gcm_mult(mbedtls_gcm_context *ctx, const unsigned char x[16],
                     unsigned char output[16])
{
    switch (ctx->acceleration) {
# 364 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
        case 1:
                       ...
                       const unsigned char *iv, size_t iv_len)
{
    ...
    if (iv_len == 12) {
        ...
        { if (0) { mbedtls_put_unaligned_uint64((work_buf) + (8), (uint64_t) (iv_bits)); } else { mbedtls_put_unaligned_uint64((work_buf) + (8), __builtin_bswap64((uint64_t) (iv_bits))); } };
...
# 467 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
int mbedtls_gcm_update_ad(mbedtls_gcm_context *ctx,
...
# 481 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
...
{
    uint32_t x = ((0) ? mbedtls_get_unaligned_uint32((y) + (12)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((y) + (12))) );
    x++;
    { if (0) { mbedtls_put_unaligned_uint32((y) + (12), (uint32_t) (x)); } else { mbedtls_put_unaligned_uint32((y) + (12), __builtin_bswap32((uint32_t) (x))); } };
}
                       ...
                       unsigned char *tag, size_t tag_len)
{
    ...
    *output_length = 0;
    ...
    if (orig_len || orig_add_len) {
        ...
        { if (0) { mbedtls_put_unaligned_uint32((work_buf) + (0), (uint32_t) ((orig_add_len >> 32))); } else { mbedtls_put_unaligned_uint32((work_buf) + (0), __builtin_bswap32((uint32_t) ((orig_add_len >> 32)))); } };
        { if (0) { mbedtls_put_unaligned_uint32((work_buf) + (4), (uint32_t) ((orig_add_len))); } else { mbedtls_put_unaligned_uint32((work_buf) + (4), __builtin_bswap32((uint32_t) ((orig_add_len)))); } };
        { if (0) { mbedtls_put_unaligned_uint32((work_buf) + (8), (uint32_t) ((orig_len >> 32))); } else { mbedtls_put_unaligned_uint32((work_buf) + (8), __builtin_bswap32((uint32_t) ((orig_len >> 32)))); } };
        { if (0) { mbedtls_put_unaligned_uint32((work_buf) + (12), (uint32_t) ((orig_len))); } else { mbedtls_put_unaligned_uint32((work_buf) + (12), __builtin_bswap32((uint32_t) ((orig_len)))); } };
...
# 731 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 3 4
                                      ((void *)0)
# 731 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
                                          , 0, &olen, tag, tag_len)) != 0) {
        return ret;
    }
...
{
    if (ctx == 
# 772 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 3 4
              ((void *)0)
# 772 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
                  ) {
        return;
    }
...
# 793 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
...
int mbedtls_gcm_self_test(int verbose)
{
    ...
    if (verbose != 0) {
# 1042 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
        printf("  GCM note: built-in implementation.\n");

    }

    static const int loop_limit =
        (sizeof(ct_test_data) / sizeof(*ct_test_data)) / 6;
    ...
    for (j = 0; j < loop_limit; j++) {
        ...
        for (i = 0; i < 6; i++) {
            ...
            ret = mbedtls_gcm_crypt_and_tag(&ctx, 1,
                                            ...
                                            buf, 16, tag_buf);
# 1091 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
            if (ret != 0) {
                goto exit;
            }
...
# 1211 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 3 4
                                          ((void *)0)
# 1211 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
                                              , 0, &olen, tag_buf, 16);
            if (ret != 0) {
                goto exit;
            }
            ...
            ret = mbedtls_gcm_finish(&ctx, 
# 1291 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c" 3 4
                                          ((void *)0)
# 1291 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/gcm.c"
                                              , 0, &olen, tag_buf, 16);
            if (ret != 0) {
                goto exit;
            }
