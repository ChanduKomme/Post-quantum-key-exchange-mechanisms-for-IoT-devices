# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
# 29 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
...
# 30 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha512.h" 1
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha512.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha512.h" 2
...
# 34 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 2
...
# 35 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 2
...
# 36 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 2
# 45 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
...
# 46 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 2
# 213 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
static void sha512_put_uint64_be(uint64_t n, unsigned char *b, uint8_t i)
{
    { if (0) { mbedtls_put_unaligned_uint64((b) + (i), (uint64_t) (n)); } else { mbedtls_put_unaligned_uint64((b) + (i), __builtin_bswap64((uint64_t) (n))); } };
}
...
{
    if (ctx == 
# 228 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 3 4
              ((void *)0)
# 228 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
                  ) {
        return;
    }
...
# 260 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
# 601 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
int mbedtls_internal_sha512_process(mbedtls_sha512_context *ctx,
                                      const unsigned char data[128])
{
    int i;
...
# 630 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
    for (i = 0; i < 8; i++) {
    ...
    for (i = 0; i < 80; i++) {
        if (i < 16) {
            local.W[i] = ((0) ? mbedtls_get_unaligned_uint64((data) + (i << 3)) : __builtin_bswap64(mbedtls_get_unaligned_uint64((data) + (i << 3))) );
        } else {
            local.W[i] = (((((local.W[i - 2])) >> ((19))) | ((local.W[i - 2]) << (64 - (19)))) ^ ((((local.W[i - 2])) >> ((61))) | ((local.W[i - 2]) << (64 - (61)))) ^ ((local.W[i - 2]) >> (6))) + local.W[i - 7] +
                         (((((local.W[i - 15])) >> ((1))) | ((local.W[i - 15]) << (64 - (1)))) ^ ((((local.W[i - 15])) >> ((8))) | ((local.W[i - 15]) << (64 - (8)))) ^ ((local.W[i - 15]) >> (7))) + local.W[i - 16];
        }

        do { local.temp1 = (local.A[7]) + (((((local.A[4])) >> ((14))) | ((local.A[4]) << (64 - (14)))) ^ ((((local.A[4])) >> ((18))) | ((local.A[4]) << (64 - (18)))) ^ ((((local.A[4])) >> ((41))) | ((local.A[4]) << (64 - (41))))) + (((local.A[6])) ^ (((local.A[4])) & (((local.A[5])) ^ ((local.A[6]))))) + (K[i]) + (local.W[i]); local.temp2 = (((((local.A[0])) >> ((28))) | ((local.A[0]) << (64 - (28)))) ^ ((((local.A[0])) >> ((34))) | ((local.A[0]) << (64 - (34)))) ^ ((((local.A[0])) >> ((39))) | ((local.A[0]) << (64 - (39))))) + ((((local.A[0])) & ((local.A[1]))) | (((local.A[2])) & (((local.A[0])) | ((local.A[1]))))); (local.A[3]) += local.temp1; (local.A[7]) = local.temp1 + local.temp2; } while (0)
                                                               ;
...
# 683 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
    for (i = 0; i < 8; i++) {
...
static size_t mbedtls_internal_sha512_process_many(
    mbedtls_sha512_context *ctx, const uint8_t *data, size_t len)
{
    size_t processed = 0;

    while (len >= 128) {
        if (mbedtls_internal_sha512_process(ctx, data) != 0) {
            return 0;
        }
...
# 760 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
int mbedtls_sha512_update(mbedtls_sha512_context *ctx,
                          const unsigned char *input,
                          size_t ilen)
{
...
# 909 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
...
static int mbedtls_sha512_common_self_test(int verbose, int is384)
{
    ...
    if (
# 1026 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c" 3 4
       ((void *)0) 
# 1026 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha512.c"
            == buf) {
        if (verbose != 0) {
