# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
...
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h" 1
# 12 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h" 2
# 32 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecp.h" 1
# 27 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecp.h"
...
# 33 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h" 2
...
int mbedtls_md_hmac(const mbedtls_md_info_t *md_info, const unsigned char *key, size_t keylen,
                    ...
                    unsigned char *output);
# 34 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/ecjpake.h" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 2
...
# 20 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 2
# 28 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
...
{
    if (ctx == 
# 72 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
              ((void *)0)
# 72 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
                  ) {
        return;
    }
                          ...
                          size_t len)
{
    ...
    if ((mbedtls_md_info_from_type(hash)) == 
# 108 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
                                            ((void *)0)
# 108 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
                                                ) {
        return -0x5080;
    }
    ...
    do { if ((ret = (mbedtls_ecp_group_load(&ctx->grp, curve))) != 0) goto cleanup; } while (0);

    do { if ((ret = (mbedtls_mpi_read_binary(&ctx->s, secret, len))) != 0) goto cleanup; } while (0);
...
int mbedtls_ecjpake_check(const mbedtls_ecjpake_context *ctx)
{
    if (ctx->md_type == MBEDTLS_MD_NONE ||
        ...
        ctx->s.p == 
# 146 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
                   ((void *)0)
# 146 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
                       ) {
        return -0x4F80;
    }
                                   ...
                                   const mbedtls_ecp_point *P)
{
    ...
    { if (0) { mbedtls_put_unaligned_uint32((*p) + (0), (uint32_t) (len)); } else { mbedtls_put_unaligned_uint32((*p) + (0), __builtin_bswap32((uint32_t) (len))); } };

    *p += 4 + len;

    return 0;
}
# 192 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
...
{
    int ret = -0x006E;
    unsigned char buf[(3 * (4 + (2 * ((521 + 7) / 8) + 1)) + 4 + 6)];
    unsigned char *p = buf;
    ...
    do { if ((ret = (ecjpake_write_len_point(&p, end, grp, pf, G))) != 0) goto cleanup; } while (0);
    do { if ((ret = (ecjpake_write_len_point(&p, end, grp, pf, V))) != 0) goto cleanup; } while (0);
    do { if ((ret = (ecjpake_write_len_point(&p, end, grp, pf, X))) != 0) goto cleanup; } while (0);

    if (end - p < 4) {
        return -0x4F00;
    }

    { if (0) { mbedtls_put_unaligned_uint32((p) + (0), (uint32_t) (id_len)); } else { mbedtls_put_unaligned_uint32((p) + (0), __builtin_bswap32((uint32_t) (id_len))); } };
    p += 4;
    ...
    do { if ((ret = (mbedtls_ecjpake_compute_hash(md_type, buf, (size_t) (p - buf), hash))) != 0) goto cleanup; } while (0)
                                                                                ;


    do { if ((ret = (mbedtls_mpi_read_binary(h, hash, mbedtls_md_get_size_from_type(md_type)))) != 0) goto cleanup; } while (0)
                                                                                    ;
    do { if ((ret = (mbedtls_mpi_mod_mpi(h, h, &grp->N))) != 0) goto cleanup; } while (0);
                            ...
                            const unsigned char *end)
{
    ...
    do { if ((ret = (mbedtls_ecp_tls_read_point(grp, &V, p, (size_t) (end - *p)))) != 0) goto cleanup; } while (0);
    ...
    do { if ((ret = (mbedtls_mpi_read_binary(&r, *p, r_len))) != 0) goto cleanup; } while (0);
    *p += r_len;




    do { if ((ret = (ecjpake_hash(md_type, grp, pf, G, &V, X, id, &h))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_ecp_muladd((mbedtls_ecp_group *) grp, &VV, &h, X, &r, G))) != 0) goto cleanup; } while (0)
                                                          ;
                             ...
                             void *p_rng)
{
    ...
    do { if ((ret = (mbedtls_ecp_gen_keypair_base((mbedtls_ecp_group *) grp, G, &v, &V, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                                          ;
    do { if ((ret = (ecjpake_hash(md_type, grp, pf, G, &V, X, id, &h))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_mul_mpi(&h, &h, x))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_sub_mpi(&h, &v, &h))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_mod_mpi(&h, &h, &grp->N))) != 0) goto cleanup; } while (0);


    do { if ((ret = (mbedtls_ecp_tls_write_point(grp, &V, pf, &len, *p, (size_t) (end - *p)))) != 0) goto cleanup; } while (0)
                                                                                   ;
    *p += len;
    ...
    *(*p)++ = ((uint8_t) ((len) & 0xff));
    do { if ((ret = (mbedtls_mpi_write_binary(&h, *p, len))) != 0) goto cleanup; } while (0);
    *p += len;
                            ...
                            const unsigned char *end)
{
    ...
    do { if ((ret = (mbedtls_ecp_tls_read_point(grp, X, p, (size_t) (end - *p)))) != 0) goto cleanup; } while (0);
    if (mbedtls_ecp_is_zero(X)) {
        ret = -0x4C80;
        goto cleanup;
    }

    do { if ((ret = (ecjpake_zkp_read(md_type, grp, pf, G, X, id, p, end))) != 0) goto cleanup; } while (0);
                             ...
                             void *p_rng)
{
    ...
    do { if ((ret = (mbedtls_ecp_gen_keypair_base((mbedtls_ecp_group *) grp, G, x, X, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                               ;
    do { if ((ret = (mbedtls_ecp_tls_write_point(grp, X, pf, &len, *p, (size_t) (end - *p)))) != 0) goto cleanup; } while (0)
                                                                                   ;
    *p += len;


    do { if ((ret = (ecjpake_zkp_write(md_type, grp, pf, G, x, X, id, p, end, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                            ;
                             ...
                             size_t len)
{
    ...
    do { if ((ret = (ecjpake_kkp_read(md_type, grp, pf, G, Xa, id, &p, end))) != 0) goto cleanup; } while (0);
    do { if ((ret = (ecjpake_kkp_read(md_type, grp, pf, G, Xb, id, &p, end))) != 0) goto cleanup; } while (0);
                              ...
                              void *p_rng)
{
    ...
    do { if ((ret = (ecjpake_kkp_write(md_type, grp, pf, G, xm1, Xa, id, &p, end, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                             ;
    do { if ((ret = (ecjpake_kkp_write(md_type, grp, pf, G, xm2, Xb, id, &p, end, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                             ;
                                   ...
                                   size_t len)
{
    return ecjpake_kkpp_read(ctx->md_type, &ctx->grp, ctx->point_format,
                             &ctx->grp.G,
                             &ctx->Xp1, &ctx->Xp2, (ecjpake_id[1 - ctx->role]),
                             buf, len);
}
                                    ...
                                    void *p_rng)
{
    return ecjpake_kkpp_write(ctx->md_type, &ctx->grp, ctx->point_format,
                              ...
                              (ecjpake_id[ctx->role]), buf, len, olen, f_rng, p_rng);
}
                            ...
                            const mbedtls_ecp_point *C)
{
    ...
    do { if ((ret = (mbedtls_ecp_muladd(grp, R, &one, A, &one, B))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_ecp_muladd(grp, R, &one, R, &one, C))) != 0) goto cleanup; } while (0);
                                   ...
                                   size_t len)
{
    ...
    do { if ((ret = (ecjpake_ecp_add3(&ctx->grp, &G, &ctx->Xm1, &ctx->Xm2, &ctx->Xp1))) != 0) goto cleanup; } while (0)
                                                                      ;
    ...
    if (ctx->role == MBEDTLS_ECJPAKE_CLIENT) {
        do { if ((ret = (mbedtls_ecp_tls_read_group(&grp, &p, len))) != 0) goto cleanup; } while (0);
    ...
    do { if ((ret = (ecjpake_kkp_read(ctx->md_type, &ctx->grp, ctx->point_format, &G, &ctx->Xp, (ecjpake_id[1 - ctx->role]), &p, end))) != 0) goto cleanup; } while (0)
                              ...
                              void *p_rng)
{
    ...
    do { if ((ret = (mbedtls_mpi_fill_random(&b, 16, f_rng, p_rng))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_mul_mpi(&b, &b, N))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_add_mpi(&b, &b, S))) != 0) goto cleanup; } while (0);


    do { if ((ret = (mbedtls_mpi_mul_mpi(R, X, &b))) != 0) goto cleanup; } while (0);
    R->s *= sign;
    do { if ((ret = (mbedtls_mpi_mod_mpi(R, R, N))) != 0) goto cleanup; } while (0);
                                    ...
                                    void *p_rng)
{
    ...
    mbedtls_mpi_init(&xm);
# 676 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
    do { if ((ret = (ecjpake_ecp_add3(&ctx->grp, &G, &ctx->Xp1, &ctx->Xp2, &ctx->Xm1))) != 0) goto cleanup; } while (0)
                                                                      ;
    do { if ((ret = (ecjpake_mul_secret(&xm, 1, &ctx->xm2, &ctx->s, &ctx->grp.N, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                                  ;
    do { if ((ret = (mbedtls_ecp_mul(&ctx->grp, &Xm, &xm, &G, f_rng, p_rng))) != 0) goto cleanup; } while (0);
# 690 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
    if (ctx->role == MBEDTLS_ECJPAKE_SERVER) {
        if (end < p) {
            ret = -0x4F00;
            goto cleanup;
        }
        do { if ((ret = (mbedtls_ecp_tls_write_group(&ctx->grp, &ec_len, p, (size_t) (end - p)))) != 0) goto cleanup; } while (0)
                                                                           ;
        p += ec_len;
    }
    ...
    do { if ((ret = (mbedtls_ecp_tls_write_point(&ctx->grp, &Xm, ctx->point_format, &ec_len, p, (size_t) (end - p)))) != 0) goto cleanup; } while (0)
                                                                                                   ;
    p += ec_len;

    do { if ((ret = (ecjpake_zkp_write(ctx->md_type, &ctx->grp, ctx->point_format, &G, &xm, &Xm, (ecjpake_id[ctx->role]), &p, end, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                    ...
                                    void *p_rng)
{
    ...
    do { if ((ret = (ecjpake_mul_secret(&m_xm2_s, -1, &ctx->xm2, &ctx->s, &ctx->grp.N, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                                  ;
    do { if ((ret = (mbedtls_ecp_muladd(&ctx->grp, K, &one, &ctx->Xp, &m_xm2_s, &ctx->Xp2))) != 0) goto cleanup; } while (0)

                                                            ;
    do { if ((ret = (mbedtls_ecp_mul(&ctx->grp, K, &ctx->xm2, K, f_rng, p_rng))) != 0) goto cleanup; } while (0)
                                                  ;
                                  ...
                                  void *p_rng)
{
    ...
    *olen = mbedtls_md_get_size_from_type(ctx->md_type);
    ...
    do { if ((ret = (mbedtls_mpi_write_binary(&K.X, kx, x_bytes))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_ecjpake_compute_hash(ctx->md_type, kx, x_bytes, buf))) != 0) goto cleanup; } while (0)
                                                                   ;
...
# 827 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
...
# 828 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 2
# 838 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
...
# 987 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
                             ...
                             const unsigned char *xm2, size_t len2)
{
    ...
    do { if ((ret = (mbedtls_mpi_read_binary(&ctx->xm1, xm1, len1))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_mpi_read_binary(&ctx->xm2, xm2, len2))) != 0) goto cleanup; } while (0);
    do { if ((ret = (mbedtls_ecp_mul(&ctx->grp, &ctx->Xm1, &ctx->xm1, &ctx->grp.G, self_test_rng, 
# 1010 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1010 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ))) != 0) goto cleanup; } while (0)
                                                                      ;
    do { if ((ret = (mbedtls_ecp_mul(&ctx->grp, &ctx->Xm2, &ctx->xm2, &ctx->grp.G, self_test_rng, 
# 1012 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1012 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ))) != 0) goto cleanup; } while (0)
                                                                      ;
...
# 1053 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
int mbedtls_ecjpake_self_test(int verbose)
{
    int ret = -0x006E;
    ...
    do { if (mbedtls_ecjpake_setup(&cli, MBEDTLS_ECJPAKE_CLIENT, MBEDTLS_MD_SHA256, MBEDTLS_ECP_DP_SECP256R1, ecjpake_test_password, sizeof(ecjpake_test_password)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)


                                                                          ;

    do { if (mbedtls_ecjpake_setup(&srv, MBEDTLS_ECJPAKE_SERVER, MBEDTLS_MD_SHA256, MBEDTLS_ECP_DP_SECP256R1, ecjpake_test_password, sizeof(ecjpake_test_password)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
    ...
    do { if (mbedtls_ecjpake_write_round_one(&cli, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1086 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1086 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                ;

    do { if (mbedtls_ecjpake_read_round_one(&srv, buf, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);

    do { if (mbedtls_ecjpake_write_round_one(&srv, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1091 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1091 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                ;

    do { if (mbedtls_ecjpake_read_round_one(&cli, buf, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);

    do { if (mbedtls_ecjpake_write_round_two(&srv, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1096 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1096 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                ;

    do { if (mbedtls_ecjpake_read_round_two(&cli, buf, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);

    do { if (mbedtls_ecjpake_derive_secret(&cli, pms, sizeof(pms), &pmslen, ecjpake_lgc, 
# 1101 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1101 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                 ;

    do { if (mbedtls_ecjpake_write_round_two(&cli, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1104 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1104 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                ;

    do { if (mbedtls_ecjpake_read_round_two(&srv, buf, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);

    do { if (mbedtls_ecjpake_derive_secret(&srv, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1109 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1109 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                              ;

    do { if (len == pmslen) ret = 0; else { ret = 1; goto cleanup; } } while (0);
    do { if (memcmp(buf, pms, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);
    ...
    do { if ((ret = (ecjpake_test_load(&cli, ecjpake_test_x1, sizeof(ecjpake_test_x1), ecjpake_test_x2, sizeof(ecjpake_test_x2)))) != 0) goto cleanup; } while (0)

                                                                                ;

    do { if ((ret = (ecjpake_test_load(&srv, ecjpake_test_x3, sizeof(ecjpake_test_x3), ecjpake_test_x4, sizeof(ecjpake_test_x4)))) != 0) goto cleanup; } while (0)

                                                                                ;


    do { if (mbedtls_ecjpake_read_round_one(&srv, ecjpake_test_cli_one, sizeof(ecjpake_test_cli_one)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)

                                                                                  ;

    do { if (mbedtls_ecjpake_read_round_one(&cli, ecjpake_test_srv_one, sizeof(ecjpake_test_srv_one)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)

                                                                                  ;


    do { if (mbedtls_ecjpake_read_round_two(&cli, ecjpake_test_srv_two, sizeof(ecjpake_test_srv_two)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)

                                                                                  ;

    do { if (mbedtls_ecjpake_read_round_two(&srv, ecjpake_test_cli_two, sizeof(ecjpake_test_cli_two)) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)

                                                                                  ;


    do { if (mbedtls_ecjpake_derive_secret(&srv, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1157 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1157 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                              ;

    do { if (len == sizeof(ecjpake_test_pms)) ret = 0; else { ret = 1; goto cleanup; } } while (0);
    do { if (memcmp(buf, ecjpake_test_pms, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);


    do { if (mbedtls_ecjpake_write_shared_key(&srv, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1164 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1164 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                 ;

    do { if (len == sizeof(ecjpake_test_shared_key)) ret = 0; else { ret = 1; goto cleanup; } } while (0);
    do { if (memcmp(buf, ecjpake_test_shared_key, len) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0);

    memset(buf, 0, len);


    do { if (mbedtls_ecjpake_derive_secret(&cli, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1173 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1173 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                              ;
    ...
    do { if (mbedtls_ecjpake_write_shared_key(&cli, buf, sizeof(buf), &len, ecjpake_lgc, 
# 1180 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c" 3 4
   ((void *)0)
# 1180 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/ecjpake.c"
   ) == 0) ret = 0; else { ret = 1; goto cleanup; } } while (0)
                                                                                                 ;
