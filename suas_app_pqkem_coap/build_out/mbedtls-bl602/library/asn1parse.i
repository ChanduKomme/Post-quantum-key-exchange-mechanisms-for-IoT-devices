# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
...
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 2
...
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 2
...
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 2
    ...
    void *ctx)
{
    ...
    while (*p < end) {
        ...
        if ((tag & tag_may_mask) == tag_may_val) {
            if (cb != 
# 254 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                     ((void *)0)
# 254 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                         ) {
...
{
    while (seq != 
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                 ((void *)0)
# 295 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                     ) {
                                   ...
                                   size_t len)
{
    ...
    if (cur->buf.p != 
# 317 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                     ((void *)0)
# 317 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                         ) {
        cur->next =
            calloc(1, sizeof(mbedtls_asn1_sequence));

        if (cur->next == 
# 321 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                        ((void *)0)
# 321 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                            ) {
            return -0x006A;
        }
...
# 433 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
void mbedtls_asn1_free_named_data_list(mbedtls_asn1_named_data **head)
{
    mbedtls_asn1_named_data *cur;

    while ((cur = *head) != 
# 437 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                           ((void *)0)
# 437 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                               ) {
        *head = cur->next;
        free(cur->oid.p);
        free(cur->val.p);
...
void mbedtls_asn1_free_named_data_list_shallow(mbedtls_asn1_named_data *name)
{
    for (mbedtls_asn1_named_data *next; name != 
# 447 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                                               ((void *)0)
# 447 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                                                   ; name = next) {
        next = name->next;
        free(name);
    }
...
{
    while (list != 
# 456 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c" 3 4
                  ((void *)0)
# 456 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1parse.c"
                      ) {
        if (list->oid.len == len &&
