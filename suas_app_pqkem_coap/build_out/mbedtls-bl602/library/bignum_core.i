# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
...
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
...
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/constant_time_internal.h" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
...
void mbedtls_mpi_core_gcd_modinv_odd(mbedtls_mpi_uint *G,
                                     ...
                                     size_t N_limbs,
                                     mbedtls_mpi_uint *T);
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core_invasive.h" 1
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bn_mul.h" 1
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 2


size_t mbedtls_mpi_core_clz(mbedtls_mpi_uint a)
{
# 37 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    return (size_t) __builtin_clz(a);
# 52 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
}
...
size_t mbedtls_mpi_core_bitlen(const mbedtls_mpi_uint *A, size_t A_limbs)
{
    ...
    for (i = ((int) A_limbs) - 1; i >= 0; i--) {
        if (A[i] != 0) {
            j = ((sizeof(mbedtls_mpi_uint)) << 3) - mbedtls_mpi_core_clz(A[i]);
...
static mbedtls_mpi_uint mpi_bigendian_to_host(mbedtls_mpi_uint a)
{
    if (0) {
        ...
        return (mbedtls_mpi_uint) __builtin_bswap32(a);
...
# 101 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                                    ...
                                                    size_t A_limbs)
{
    ...
    mbedtls_ct_condition_t msll_mask = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0));
...
mbedtls_ct_condition_t mbedtls_mpi_core_lt_ct(const mbedtls_mpi_uint *A,
                                              ...
                                              size_t limbs)
{
    mbedtls_ct_condition_t ret = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0)), cond = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0)), done = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0));
...
int mbedtls_mpi_core_read_le(mbedtls_mpi_uint *X,
                             ...
                             size_t input_length)
{
    const size_t limbs = ((input_length) / (sizeof(mbedtls_mpi_uint)) + ((input_length) % (sizeof(mbedtls_mpi_uint)) != 0));
    ...
    if (X != 
# 215 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
            ((void *)0)
# 215 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                ) {
        memset(X, 0, X_limbs * (sizeof(mbedtls_mpi_uint)));

        for (size_t i = 0; i < input_length; i++) {
            size_t offset = ((i % (sizeof(mbedtls_mpi_uint))) << 3);
            X[i / (sizeof(mbedtls_mpi_uint))] |= ((mbedtls_mpi_uint) input[i]) << offset;
        }
    }
                             ...
                             size_t input_length)
{
    ...
    if (input_length != 0) {
        size_t overhead = (X_limbs * (sizeof(mbedtls_mpi_uint))) - input_length;
...
int mbedtls_mpi_core_write_le(const mbedtls_mpi_uint *A,
                              ...
                              size_t output_length)
{
    size_t stored_bytes = A_limbs * (sizeof(mbedtls_mpi_uint));
    ...
    if (stored_bytes < output_length) {
        ...
        for (size_t i = bytes_to_copy; i < stored_bytes; i++) {
            if ((((A)[(i) / (sizeof(mbedtls_mpi_uint))] >> (((i) % (sizeof(mbedtls_mpi_uint))) * 8)) & 0xff) != 0) {
                return -0x0008;
            }
        }
    }
    ...
    for (size_t i = 0; i < bytes_to_copy; i++) {
        output[i] = (((A)[(i) / (sizeof(mbedtls_mpi_uint))] >> (((i) % (sizeof(mbedtls_mpi_uint))) * 8)) & 0xff);
    }
                              ...
                              size_t output_length)
{
    ...
    stored_bytes = X_limbs * (sizeof(mbedtls_mpi_uint));
    ...
    if (stored_bytes < output_length) {
        ...
        p = output;
        for (size_t i = bytes_to_copy; i < stored_bytes; i++) {
            if ((((X)[(i) / (sizeof(mbedtls_mpi_uint))] >> (((i) % (sizeof(mbedtls_mpi_uint))) * 8)) & 0xff) != 0) {
                return -0x0008;
            }
        }
    }
    ...
    for (size_t i = 0; i < bytes_to_copy; i++) {
        p[bytes_to_copy - i - 1] = (((X)[(i) / (sizeof(mbedtls_mpi_uint))] >> (((i) % (sizeof(mbedtls_mpi_uint))) * 8)) & 0xff);
    }
                              ...
                              size_t count)
{
    ...
    if (v0 > limbs || (v0 == limbs && v1 > 0)) {
        memset(X, 0, limbs * (sizeof(mbedtls_mpi_uint)));
        return;
    }
    ...
    if (v1 > 0) {
        for (i = limbs; i > 0; i--) {
            r1 = X[i - 1] << (((sizeof(mbedtls_mpi_uint)) << 3) - v1);
            X[i - 1] >>= v1;
            X[i - 1] |= r0;
            r0 = r1;
        }
                              ...
                              size_t count)
{
    ...
    if (v1 > 0) {
        for (i = v0; i < limbs; i++) {
            r1 = X[i] >> (((sizeof(mbedtls_mpi_uint)) << 3) - v1);
            X[i] <<= v1;
            X[i] |= r0;
            r0 = r1;
        }
                                      ...
                                      mbedtls_mpi_uint b)
{
    ...
    while (steps_x8--) {
        { mbedtls_mpi_uint s0, s1, b0, b1; mbedtls_mpi_uint r0, r1, rx, ry; b0 = ( b << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); b1 = ( b >> ((sizeof(mbedtls_mpi_uint)) << 2) );
        s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0; s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0;
            }
    }

    while (steps_x1--) {
        { mbedtls_mpi_uint s0, s1, b0, b1; mbedtls_mpi_uint r0, r1, rx, ry; b0 = ( b << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); b1 = ( b >> ((sizeof(mbedtls_mpi_uint)) << 2) );
        s0 = ( *s << ((sizeof(mbedtls_mpi_uint)) << 2) ) >> ((sizeof(mbedtls_mpi_uint)) << 2); s1 = ( *s >> ((sizeof(mbedtls_mpi_uint)) << 2) ); s++; rx = s0 * b1; r0 = s0 * b0; ry = s1 * b0; r1 = s1 * b1; r1 += ( rx >> ((sizeof(mbedtls_mpi_uint)) << 2) ); r1 += ( ry >> ((sizeof(mbedtls_mpi_uint)) << 2) ); rx <<= ((sizeof(mbedtls_mpi_uint)) << 2); ry <<= ((sizeof(mbedtls_mpi_uint)) << 2); r0 += rx; r1 += (r0 < rx); r0 += ry; r1 += (r0 < ry); r0 += c; r1 += (r0 < c); r0 += *d; r1 += (r0 < *d); c = r1; *(d++) = r0;
            }
    }
...
void mbedtls_mpi_core_mul(mbedtls_mpi_uint *X,
                          ...
                          const mbedtls_mpi_uint *B, size_t B_limbs)
{
    memset(X, 0, (A_limbs + B_limbs) * (sizeof(mbedtls_mpi_uint)));
...
void mbedtls_mpi_core_montmul(mbedtls_mpi_uint *X,
                              ...
                              mbedtls_mpi_uint *T)
{
    memset(T, 0, (2 * AN_limbs + 1) * (sizeof(mbedtls_mpi_uint)));
...
# 559 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    mbedtls_mpi_uint carry = T[AN_limbs];
    mbedtls_mpi_uint borrow = mbedtls_mpi_core_sub(X, T, N, AN_limbs);
# 576 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    mbedtls_ct_memcpy_if(mbedtls_ct_bool(carry ^ borrow),
                         (unsigned char *) X,
                         (unsigned char *) T,
                         
# 579 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
                        ((void *)0)
# 579 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                            ,
    ...
    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
    ...
    memset(X, 0, overhead);
    memset((unsigned char *) X + limbs * (sizeof(mbedtls_mpi_uint)), 0, (X_limbs - limbs) * (sizeof(mbedtls_mpi_uint)));
    do { if ((ret = (f_rng(p_rng, (unsigned char *) X + overhead, n_bytes))) != 0) goto cleanup; } while (0);
...
int mbedtls_mpi_core_random(mbedtls_mpi_uint *X,
                            ...
                            void *p_rng)
{
    mbedtls_ct_condition_t ge_lower = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0xffffffffUL
# 645 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                     )), lt_upper = ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0));
    size_t n_bits = mbedtls_mpi_core_bitlen(N, limbs);
    size_t n_bytes = (n_bits + 7) / 8;
    int ret = -0x006E;
# 667 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    int count = (n_bytes > 4 ? 30 : 250);
# 677 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    do {
        do { if ((ret = (mbedtls_mpi_core_fill_random(X, limbs, n_bytes, f_rng, p_rng))) != 0) goto cleanup; } while (0)
    ...
    } while (mbedtls_ct_bool_and(ge_lower, lt_upper) == ((mbedtls_ct_condition_t) mbedtls_ct_compiler_opaque(0)));
...
size_t mbedtls_mpi_core_exp_mod_working_limbs(size_t AN_limbs, size_t E_limbs)
{
    const size_t wsize = exp_mod_get_window_size(E_limbs * ((sizeof(mbedtls_mpi_uint)) << 3));
...
# 762 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                                          ...
                                                          size_t *E_bit_index)
{
    if (E_public == 0x2a2a2a2a) {
        ...
        *E_limb_index = E_bits / ((sizeof(mbedtls_mpi_uint)) << 3);
        *E_bit_index = E_bits % ((sizeof(mbedtls_mpi_uint)) << 3);
...
static inline void exp_mod_table_lookup_optionally_safe(mbedtls_mpi_uint *Wselect,
                                                        ...
                                                        int window_public)
{
    if (window_public == 0x2a2a2a2a) {
        memcpy(Wselect, Wtable + window * AN_limbs, AN_limbs * (sizeof(mbedtls_mpi_uint)));
...
# 850 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                                     ...
                                                     mbedtls_mpi_uint *T)
{
    ...
    const size_t wsize = exp_mod_get_window_size(E_limb_index * ((sizeof(mbedtls_mpi_uint)) << 3));
    const size_t welem = ((size_t) 1) << wsize;
    ...
    memcpy(X, Wtable, AN_limbs * (sizeof(mbedtls_mpi_uint)));
    ...
    do {
        ...
        if (E_bit_index == 0) {
            --E_limb_index;
            E_bit_index = ((sizeof(mbedtls_mpi_uint)) << 3) - 1;
        } else {
            --E_bit_index;
        }
                                   ...
                                   size_t limbs)
{
    ...
    X[limbs - 1] |= c << (((sizeof(mbedtls_mpi_uint)) << 3) - 1);
}
# 1092 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
void mbedtls_mpi_core_gcd_modinv_odd(mbedtls_mpi_uint *G,
                                     mbedtls_mpi_uint *I,
                                     const mbedtls_mpi_uint *A,
                                     size_t A_limbs,
                                     ...
                                     mbedtls_mpi_uint *T)
{
    ...
    mbedtls_mpi_uint *r = I != 
# 1113 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
                              ((void *)0) 
# 1113 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                   ? T + 4 * N_limbs : 
# 1113 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
                                                       ((void *)0)
# 1113 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                                                           ;
# 1124 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    if (A_limbs > N_limbs) {

        A_limbs = N_limbs;
    }
    memcpy(u, A, A_limbs * (sizeof(mbedtls_mpi_uint)));
    memset((char *) u + A_limbs * (sizeof(mbedtls_mpi_uint)), 0, (N_limbs - A_limbs) * (sizeof(mbedtls_mpi_uint)));


    if (v != N) {
        memcpy(v, N, N_limbs * (sizeof(mbedtls_mpi_uint)));
    }

    if (I != 
# 1136 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
            ((void *)0)
# 1136 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                ) {
        memset(q, 0, N_limbs * (sizeof(mbedtls_mpi_uint)));

        memset(r, 0, N_limbs * (sizeof(mbedtls_mpi_uint)));
        r[0] = 1;
    }
# 1165 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
    for (size_t i = 0; i < (A_limbs + N_limbs) * ((sizeof(mbedtls_mpi_uint)) << 3); i++) {
        ...
        memcpy(t1, d, N_limbs * (sizeof(mbedtls_mpi_uint)));
        mbedtls_mpi_core_cond_assign(t1, u, N_limbs, u_odd_v_odd);



        memcpy(t2, u, N_limbs * (sizeof(mbedtls_mpi_uint)));
        mbedtls_mpi_core_cond_assign(t2, v, N_limbs, u_odd_v_even);
        mbedtls_mpi_core_cond_assign(t2, d, N_limbs, u_odd_v_odd);

        mbedtls_mpi_core_shift_r(t2, N_limbs, 1);


        memcpy(u, t1, N_limbs * (sizeof(mbedtls_mpi_uint)));
        memcpy(v, t2, N_limbs * (sizeof(mbedtls_mpi_uint)));
        mbedtls_ct_condition_t swap = mbedtls_mpi_core_lt_ct(v, u, N_limbs);
        mbedtls_mpi_core_cond_swap(u, v, N_limbs, swap);
# 1215 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
        if (I != 
# 1215 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c" 3 4
                ((void *)0)
# 1215 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/bignum_core.c"
                    ) {
            ...
            memcpy(t2, r, N_limbs * (sizeof(mbedtls_mpi_uint)));
            ...
            memcpy(r, t1, N_limbs * (sizeof(mbedtls_mpi_uint)));
            memcpy(q, t2, N_limbs * (sizeof(mbedtls_mpi_uint)));
