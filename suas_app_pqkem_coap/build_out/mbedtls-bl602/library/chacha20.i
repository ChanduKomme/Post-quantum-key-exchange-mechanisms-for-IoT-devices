# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
# 12 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
...
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/chacha20.h" 1
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/chacha20.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/chacha20.h" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2

# 1 "/home/chandu/sdk/bl602_iot_sdk/toolchain/compiler/lib/gcc/riscv32-unknown-elf/15.1.0/include/stddef.h" 1 3 4
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 2
# 49 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
                                          ...
                                          size_t d)
{
    ...
    state[a] += state[b];
    state[d] ^= state[a];
    state[d] = ((uint32_t) ((state[d]) << (16)) | ((state[d]) >> (32 - (16))));


    state[c] += state[d];
    state[b] ^= state[c];
    state[b] = ((uint32_t) ((state[b]) << (12)) | ((state[b]) >> (32 - (12))));


    state[a] += state[b];
    state[d] ^= state[a];
    state[d] = ((uint32_t) ((state[d]) << (8)) | ((state[d]) >> (32 - (8))));


    state[c] += state[d];
    state[b] ^= state[c];
    state[b] = ((uint32_t) ((state[b]) << (7)) | ((state[b]) >> (32 - (7))));
}
# 84 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
                           ...
                           unsigned char keystream[64])
{
    ...
    for (i = 0U; i < 16; i++) {
        ...
        { if (0) { mbedtls_put_unaligned_uint32((keystream) + (offset), __builtin_bswap32((uint32_t) (working_state[i]))); } else { mbedtls_put_unaligned_uint32((keystream) + (offset), ((uint32_t) (working_state[i]))); } };
    }
...
void mbedtls_chacha20_init(mbedtls_chacha20_context *ctx)
{
    ...
    ctx->keystream_bytes_used = (4U * 16U);
}

void mbedtls_chacha20_free(mbedtls_chacha20_context *ctx)
{
    if (ctx != 
# 154 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c" 3 4
              ((void *)0)
# 154 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
                  ) {
                            ...
                            const unsigned char key[32])
{
    ...
    ctx->state[4] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (0))) : mbedtls_get_unaligned_uint32((key) + (0)) );
    ctx->state[5] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (4))) : mbedtls_get_unaligned_uint32((key) + (4)) );
    ctx->state[6] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (8))) : mbedtls_get_unaligned_uint32((key) + (8)) );
    ctx->state[7] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (12))) : mbedtls_get_unaligned_uint32((key) + (12)) );
    ctx->state[8] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (16))) : mbedtls_get_unaligned_uint32((key) + (16)) );
    ctx->state[9] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (20))) : mbedtls_get_unaligned_uint32((key) + (20)) );
    ctx->state[10] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (24))) : mbedtls_get_unaligned_uint32((key) + (24)) );
    ctx->state[11] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((key) + (28))) : mbedtls_get_unaligned_uint32((key) + (28)) );
                            ...
                            uint32_t counter)
{
    ...
    ctx->state[13] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((nonce) + (0))) : mbedtls_get_unaligned_uint32((nonce) + (0)) );
    ctx->state[14] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((nonce) + (4))) : mbedtls_get_unaligned_uint32((nonce) + (4)) );
    ctx->state[15] = ((0) ? __builtin_bswap32(mbedtls_get_unaligned_uint32((nonce) + (8))) : mbedtls_get_unaligned_uint32((nonce) + (8)) );
                            ...
                            unsigned char *output)
{
    ...
    while (size > 0U && ctx->keystream_bytes_used < (4U * 16U)) {
...
# 460 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/chacha20.c"
int mbedtls_chacha20_self_test(int verbose)
{
    ...
    for (i = 0U; i < 2U; i++) {
        ...
        do { if (!(0 == ret)) { if (verbose != 0) printf ("error code: %i\n", ret); return -1; } } while (0);

        do { if (!(0 == memcmp(output, test_output[i], test_lengths[i]))) { if (verbose != 0) printf ("failed (output)\n"); return -1; } } while (0)
                                     ;
