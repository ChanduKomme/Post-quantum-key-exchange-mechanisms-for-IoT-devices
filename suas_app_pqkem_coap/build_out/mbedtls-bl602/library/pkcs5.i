# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h" 1
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h"
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h" 2

# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/asn1.h" 1
# 12 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/asn1.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/asn1.h" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h" 2
...
int mbedtls_md_hmac(const mbedtls_md_info_t *md_info, const unsigned char *key, size_t keylen,
                    ...
                    unsigned char *output);
# 20 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h" 2
...
int mbedtls_cipher_auth_decrypt_ext(mbedtls_cipher_context_t *ctx,
                                    ...
                                    unsigned char *output, size_t output_len,
                                    size_t *olen, size_t tag_len);
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/pkcs5.h" 2
...
# 23 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2
...
# 31 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2
...
# 36 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2
...
# 38 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 2
                                     ...
                                     int *keylen, mbedtls_md_type_t *md_type)
{
    ...
    if (params->tag != (0x20 | 0x10)) {
        return mbedtls_error_add(-0x2f00, -0x0062, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 50)
                                                                 ;
    }
# 62 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
    if ((ret = mbedtls_asn1_get_tag(&p, end, &salt->len,
                                    0x04)) != 0) {
        return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 64);
    }
    ...
    if ((ret = mbedtls_asn1_get_int(&p, end, iterations)) != 0) {
        return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 71);
    }
    ...
    if ((ret = mbedtls_asn1_get_int(&p, end, keylen)) != 0) {
        if (ret != -0x0062) {
            return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 80);
        }
    }
    ...
    if ((ret = mbedtls_asn1_get_alg_null(&p, end, &prf_alg_oid)) != 0) {
        return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 89);
    }
    ...
    if (p != end) {
        return mbedtls_error_add(-0x2f00, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 97)
                                                                  ;
    }

    return 0;
}
# 129 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
int mbedtls_pkcs5_pbes2_ext(const mbedtls_asn1_buf *pbe_params, int mode,
                            const unsigned char *pwd, size_t pwdlen,
                            const unsigned char *data, size_t datalen,
                            unsigned char *output, size_t output_size,
                            size_t *output_len)
{
    ...
    if (pbe_params->tag != (0x20 | 0x10)) {
        return mbedtls_error_add(-0x2f00, -0x0062, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 156)
                                                                 ;
    }

    if ((ret = mbedtls_asn1_get_alg(&p, end, &kdf_alg_oid,
                                    &kdf_alg_params)) != 0) {
        return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 162);
    }
    ...
    if ((ret = mbedtls_asn1_get_alg(&p, end, &enc_scheme_oid,
                                    &enc_scheme_params)) != 0) {
        return mbedtls_error_add(-0x2f00, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c", 179);
    }
    ...
    if (cipher_info == 
# 187 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 3 4
                      ((void *)0)
# 187 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
                          ) {
        return -0x2e80;
    }
...
# 251 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
...
cleanup:
    ...
    mbedtls_platform_zeroize(work, 64);
    mbedtls_platform_zeroize(md1, 64);

    return ret;
}
# 369 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
                                  ...
                                  uint32_t key_length, unsigned char *output)
{
    ...
    const mbedtls_md_info_t *md_info = 
# 376 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 3 4
                                      ((void *)0)
# 376 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
                                          ;
    int ret = -0x006E;

    md_info = mbedtls_md_info_from_type(md_alg);
    if (md_info == 
# 380 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c" 3 4
                  ((void *)0)
# 380 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
                      ) {
        return -0x2e80;
    }
...
# 411 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkcs5.c"
static const size_t plen_test_data[6] =
{ 8, 8, 8, 24, 9 };

static const unsigned char password_test_data[6][32] =
{
    "password",
    "password",
    "password",
...
static const size_t slen_test_data[6] =
{ 4, 4, 4, 36, 5 };

static const unsigned char salt_test_data[6][40] =
{
    "salt",
    "salt",
    "salt",
...
static const uint32_t it_cnt_test_data[6] =
{ 1, 2, 4096, 4096, 4096 };

static const uint32_t key_len_test_data[6] =
{ 20, 20, 20, 25, 16 };

static const unsigned char result_key_test_data[6][32] =
{
