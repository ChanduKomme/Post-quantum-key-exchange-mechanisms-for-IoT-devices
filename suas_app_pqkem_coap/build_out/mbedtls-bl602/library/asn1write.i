# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
...
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data(mbedtls_asn1_named_data **list,
                                                       ...
                                                       size_t val_len);
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 2
...
# 19 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 2
...
int mbedtls_asn1_write_mpi(unsigned char **p, const unsigned char *start, const mbedtls_mpi *X)
{
    ...
    ret = mbedtls_asn1_write_len_and_tag(p, start, len, 0x02);
...
int mbedtls_asn1_write_null(unsigned char **p, const unsigned char *start)
{
    ...
    return mbedtls_asn1_write_len_and_tag(p, start, 0, 0x05);
}
                           ...
                           const char *oid, size_t oid_len)
{
    ...
    do { if ((ret = (mbedtls_asn1_write_raw_buffer(p, start, (const unsigned char *) oid, oid_len))) < 0) return ret; else (len) += ret; } while (0)
                                                                                                  ;
    return mbedtls_asn1_write_len_and_tag(p, start, len, 0x06);
}
...
int mbedtls_asn1_write_bool(unsigned char **p, const unsigned char *start, int boolean)
{
    ...
    *--(*p) = (boolean) ? 255 : 0;
    ...
    return mbedtls_asn1_write_len_and_tag(p, start, len, 0x01);
}
                                 ...
                                 const unsigned char *buf, size_t bits)
{
    ...
    *--(*p) = (unsigned char) unused_bits;
    ...
    return mbedtls_asn1_write_len_and_tag(p, start, len, 0x03);
}
                                    ...
                                    const unsigned char *buf, size_t size)
{
    ...
    return mbedtls_asn1_write_len_and_tag(p, start, len, 0x04);
}
# 376 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
    ...
    size_t val_len)
{
    ...
    if ((cur = ((mbedtls_asn1_named_data *) mbedtls_asn1_find_named_data(*head, oid, oid_len))) == 
# 384 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                                                            ((void *)0)
# 384 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                                                                ) {
        ...
        if (cur == 
# 389 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                  ((void *)0)
# 389 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                      ) {
            return 
# 390 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                  ((void *)0)
# 390 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                      ;
        }
        ...
        if (cur->oid.p == 
# 395 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                         ((void *)0)
# 395 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                             ) {
            free(cur);
            return 
# 397 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                  ((void *)0)
# 397 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                      ;
        }
        ...
        if (val_len != 0) {
            ...
            if (cur->val.p == 
# 405 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                             ((void *)0)
# 405 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                                 ) {
                free(cur->oid.p);
                free(cur);
                return 
# 408 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                      ((void *)0)
# 408 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                          ;
            }
        }
        ...
        *head = cur;
        ...
        free(cur->val.p);
        cur->val.p = 
# 416 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                    ((void *)0)
# 416 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                        ;
        cur->val.len = 0;
        ...
        if (p == 
# 425 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                ((void *)0)
# 425 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                    ) {
            return 
# 426 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
                  ((void *)0)
# 426 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                      ;
        }
    ...
    if (val != 
# 434 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c" 3 4
              ((void *)0) 
# 434 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/asn1write.c"
                   && val_len != 0) {
