# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
...
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data(mbedtls_asn1_named_data **list,
                                                       ...
                                                       size_t val_len);
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
# 18 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
# 30 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.h" 1
# 31 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
int mbedtls_rsa_rsassa_pss_sign_no_mode_check(mbedtls_rsa_context *ctx,
                                              ...
                                              const unsigned char *hash,
                                              unsigned char *sig);
# 37 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
...
# 44 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 2
# 62 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
static int pk_write_rsa_der(unsigned char **p, unsigned char *buf,
                            const mbedtls_pk_context *pk)
{
# 85 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
    return mbedtls_rsa_write_key(mbedtls_pk_rsa(*pk), buf, p);
}
# 119 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
                              ...
                              const mbedtls_pk_context *pk)
{
    ...
    int ret = -0x006E;
# 141 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
    {
...
# 192 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
static int pk_write_ec_private(unsigned char **p, unsigned char *start,
                               const mbedtls_pk_context *pk)
{
    size_t byte_length;
    int ret = -0x006E;
    unsigned char tmp[((521 + 7) / 8)];
# 209 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
    {
...
# 263 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
                                   ...
                                   const mbedtls_pk_context *pk)
{
    ...
    do { if ((ret = (pk_write_ec_private(p, buf, pk))) < 0) return ret; else (len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_len(p, buf, len))) < 0) return ret; else (len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(p, buf, 0x04))) < 0) return ret; else (len) += ret; } while (0);
    ...
    do { if ((ret = (mbedtls_asn1_write_algorithm_identifier_ext(p, buf, oid, oid_len, 0, 0))) < 0) return ret; else (len) += ret; } while (0)
                                                                                                 ;


    do { if ((ret = (mbedtls_asn1_write_int(p, buf, 0))) < 0) return ret; else (len) += ret; } while (0);
...
# 306 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
                           ...
                           const mbedtls_pk_context *pk)
{
    ...
    do { if ((ret = (pk_write_ec_pubkey(p, buf, pk))) < 0) return ret; else (pub_len) += ret; } while (0);
    ...
    **p = 0;
    ...
    do { if ((ret = (mbedtls_asn1_write_len(p, buf, pub_len))) < 0) return ret; else (pub_len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(p, buf, 0x03))) < 0) return ret; else (pub_len) += ret; } while (0);

    do { if ((ret = (mbedtls_asn1_write_len(p, buf, pub_len))) < 0) return ret; else (pub_len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(p, buf, 0x80 | 0x20 | 1))) < 0) return ret; else (pub_len) += ret; } while (0)
    ...
    grp_id = mbedtls_pk_get_ec_group_id(pk);
    do { if ((ret = (pk_write_ec_param(p, buf, grp_id))) < 0) return ret; else (par_len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_len(p, buf, par_len))) < 0) return ret; else (par_len) += ret; } while (0);
    do { if ((ret = (mbedtls_asn1_write_tag(p, buf, 0x80 | 0x20 | 0))) < 0) return ret; else (par_len) += ret; } while (0)
    ...
    do { if ((ret = (mbedtls_asn1_write_int(p, buf, 1))) < 0) return ret; else (len) += ret; } while (0);
...
# 389 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
static mbedtls_pk_type_t pk_get_type_ext(const mbedtls_pk_context *pk)
{
    mbedtls_pk_type_t pk_type = mbedtls_pk_get_type(pk);
# 413 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
    return pk_type;
}
                            ...
                            const mbedtls_pk_context *key)
{
    ...
    if (mbedtls_pk_get_type(key) == MBEDTLS_PK_RSA) {
        do { if ((ret = (mbedtls_rsa_write_pubkey(mbedtls_pk_rsa(*key), start, p))) < 0) return ret; else (len) += ret; } while (0);
    } else


    if (mbedtls_pk_get_type(key) == MBEDTLS_PK_ECKEY) {
        do { if ((ret = (pk_write_ec_pubkey(p, start, key))) < 0) return ret; else (len) += ret; } while (0);
    } else
...
int mbedtls_pk_write_pubkey_der(const mbedtls_pk_context *key, unsigned char *buf, size_t size)
{
    ...
    const char *oid = 
# 452 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c" 3 4
                     ((void *)0)
# 452 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/pkwrite.c"
                         ;
    ...
    *--c = 0;
    ...
    if (pk_get_type_ext(key) == MBEDTLS_PK_ECKEY) {
        ...
        if (((ec_grp_id == MBEDTLS_ECP_DP_CURVE25519) || (ec_grp_id == MBEDTLS_ECP_DP_CURVE448))) {
            ...
            do { if ((ret = (pk_write_ec_param(&c, buf, ec_grp_id))) < 0) return ret; else (par_len) += ret; } while (0);
        }
    }
    ...
    do { if ((ret = (mbedtls_asn1_write_algorithm_identifier_ext(&c, buf, oid, oid_len, par_len, has_par))) < 0) return ret; else (len) += ret; } while (0)
                                                                                            ;
