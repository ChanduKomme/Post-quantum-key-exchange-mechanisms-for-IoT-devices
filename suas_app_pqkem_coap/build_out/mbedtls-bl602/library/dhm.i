# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
...
# 21 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
...
int mbedtls_mpi_inv_mod_even_in_range(mbedtls_mpi *X,
                                      mbedtls_mpi const *A,
                                      mbedtls_mpi const *N);
# 22 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
...
# 24 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
# 32 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
...
# 33 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
...
# 36 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 2
                           ...
                           const unsigned char *end)
{
    ...
    if ((ret = mbedtls_mpi_read_binary(X, *p, n)) != 0) {
        return mbedtls_error_add(-0x3100, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 60);
    }
...
# 80 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
...
# 118 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 3 4
                            ((void *)0)
# 118 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
                                ;
    switch (param) {
...
# 252 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
...
cleanup:
    if (ret != 0 && ret > -128) {
        ret = mbedtls_error_add(-0x3180, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 265);
    }
    return ret;
}
                          ...
                          const mbedtls_mpi *G)
{
    ...
    if ((ret = mbedtls_mpi_copy(&ctx->P, P)) != 0 ||
        ...
        return mbedtls_error_add(-0x3580, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 281);
    }
                            ...
                            const unsigned char *input, size_t ilen)
{
    ...
    if ((ret = mbedtls_mpi_read_binary(&ctx->GY, input, ilen)) != 0) {
        return mbedtls_error_add(-0x3200, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 300);
    }
...
cleanup:
    if (ret != 0 && ret > -128) {
        ret = mbedtls_error_add(-0x3280, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 332);
    }
    return ret;
}
# 344 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
...
# 383 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 3 4
   ((void *)0)
# 383 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
   , &ctx->Vf, &ctx->Vi, &ctx->P))) != 0) goto cleanup; } while (0);
                            ...
                            void *p_rng)
{
    ...
    if (f_rng == 
# 401 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 3 4
                ((void *)0)
# 401 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
                    ) {
        return -0x3080;
    }
...
cleanup:
    ...
    if (ret != 0) {
        return mbedtls_error_add(-0x3300, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 437);
    }
...
{
    if (ctx == 
# 448 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c" 3 4
              ((void *)0)
# 448 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
                  ) {
        return;
    }
                          ...
                          size_t dhminlen)
{
    ...
    size_t len;
    unsigned char *p, *end;
# 504 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
    p = (unsigned char *) dhmin;

    end = p + dhminlen;
# 515 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
    if ((ret = mbedtls_asn1_get_tag(&p, end, &len,
                                    0x20 | 0x10)) != 0) {
        ret = mbedtls_error_add(-0x3380, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 517);
        goto exit;
    }
    ...
    if ((ret = mbedtls_asn1_get_mpi(&p, end, &dhm->P)) != 0 ||
        ...
        ret = mbedtls_error_add(-0x3380, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 525);
        goto exit;
    }
    ...
    if (p != end) {
        ...
        if (ret != 0) {
            ret = mbedtls_error_add(-0x3380, ret, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 537);
            goto exit;
        }
        if (p != end) {
            ret = mbedtls_error_add(-0x3380, -0x0066, "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c", 541)
                                                                     ;
            goto exit;
        }
    }
...
# 645 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/dhm.c"
