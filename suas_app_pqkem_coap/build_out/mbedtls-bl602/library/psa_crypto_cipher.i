# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
# 9 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
...
# 10 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.h" 1
# 12 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.h"
...
int mbedtls_cipher_auth_decrypt_ext(mbedtls_cipher_context_t *ctx,
                                    ...
                                    unsigned char *output, size_t output_len,
                                    size_t *olen, size_t tag_len);
# 13 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.h" 2
...
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.h" 2
...
psa_status_t mbedtls_psa_cipher_decrypt(const psa_key_attributes_t *attributes,
                                        ...
                                        size_t output_size,
                                        size_t *output_length);
# 14 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2
...
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2
...
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2
...
# 17 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2
...
# 20 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 2
# 30 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
    ...
    psa_key_type_t key_type)
{
    ...
    do { if (!(key_type != ((psa_key_type_t) 0x2406))) __builtin_unreachable(); } while (0);


    do { if (!(key_type != ((psa_key_type_t) 0x2403))) __builtin_unreachable(); } while (0);
# 61 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
    do { if (!(alg != (((((psa_algorithm_t) 0x05100500)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000))))) __builtin_unreachable(); } while (0);
# 88 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
    if (alg == ((psa_algorithm_t) 0x04800100) ||
        alg == (((((psa_algorithm_t) 0x05100500)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000)))) {
        if (key_type == ((psa_key_type_t) 0x2004)) {
            return ((psa_status_t)0);
        }
    }

    if (alg == (((((psa_algorithm_t) 0x05500100)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000))) ||
        alg == (((((psa_algorithm_t) 0x05500200)) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000))) ||
        alg == ((psa_algorithm_t) 0x04c01300)) {
        if (key_type == ((psa_key_type_t) 0x2400) ||
            key_type == ((psa_key_type_t) 0x2406) ||
            key_type == ((psa_key_type_t) 0x2403)) {
            return ((psa_status_t)0);
        }
    }

    if (alg == ((psa_algorithm_t) 0x04c01000) ||
        alg == ((psa_algorithm_t) 0x04c01100) ||
        alg == ((psa_algorithm_t) 0x04c01200) ||
        alg == ((psa_algorithm_t) 0x0440ff00) ||
        alg == ((psa_algorithm_t) 0x04404400) ||
        alg == ((psa_algorithm_t) 0x04404000) ||
        alg == ((psa_algorithm_t) 0x04404100) ||
        alg == ((psa_algorithm_t) 0x03c00200)) {
        if (key_type == ((psa_key_type_t) 0x2400) ||
            key_type == ((psa_key_type_t) 0x2406) ||
            key_type == ((psa_key_type_t) 0x2301) ||
            key_type == ((psa_key_type_t) 0x2403)) {
            return ((psa_status_t)0);
        }
    }
    ...
    mbedtls_cipher_id_t *cipher_id)
{
    ...
    if ((((alg) & ((psa_algorithm_t) 0x7f000000)) == ((psa_algorithm_t) 0x05000000))) {
        alg = (((alg) & ~(((psa_algorithm_t) 0x003f0000) | ((psa_algorithm_t) 0x00008000))) | ((0) << 16 & ((psa_algorithm_t) 0x003f0000)));
    }

    if ((((alg) & ((psa_algorithm_t) 0x7f000000)) == ((psa_algorithm_t) 0x04000000)) || (((alg) & ((psa_algorithm_t) 0x7f000000)) == ((psa_algorithm_t) 0x05000000))) {
        switch (alg) {

            case ((psa_algorithm_t) 0x04800100):
                *mode = MBEDTLS_MODE_STREAM;
                break;


            case ((psa_algorithm_t) 0x04c01000):
                *mode = MBEDTLS_MODE_CTR;
                break;


            case ((psa_algorithm_t) 0x04c01100):
                *mode = MBEDTLS_MODE_CFB;
                break;


            case ((psa_algorithm_t) 0x04c01200):
                *mode = MBEDTLS_MODE_OFB;
                break;


            case ((psa_algorithm_t) 0x04404400):
                *mode = MBEDTLS_MODE_ECB;
                break;


            case ((psa_algorithm_t) 0x04404000):
                *mode = MBEDTLS_MODE_CBC;
                break;


            case ((psa_algorithm_t) 0x04404100):
                *mode = MBEDTLS_MODE_CBC;
                break;


            case ((psa_algorithm_t) 0x04c01300):
    ...
    } else if (alg == ((psa_algorithm_t) 0x03c00200)) {
        *mode = MBEDTLS_MODE_ECB;
    } else {
        return ((psa_status_t)-134);
    }
    ...
    if (cipher_id != 
# 248 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
                    ((void *)0)
# 248 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                        ) {
    ...
    mbedtls_cipher_id_t *cipher_id)
{
    ...
    if (status != ((psa_status_t)0)) {
        return 
# 268 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
              ((void *)0)
# 268 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                  ;
    }
    if (cipher_id != 
# 270 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
                    ((void *)0)
# 270 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                        ) {
        *cipher_id = cipher_id_tmp;
    }
    ...
    mbedtls_operation_t cipher_operation)
{
    ...
    size_t key_bits;
    const mbedtls_cipher_info_t *cipher_info = 
# 289 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
                                              ((void *)0)
# 289 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                                                  ;
    ...
    cipher_info = mbedtls_cipher_info_from_psa(alg, key_type,
                                               key_bits, 
# 299 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
                                                        ((void *)0)
# 299 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                                                            );
    if (cipher_info == 
# 300 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c" 3 4
                      ((void *)0)
# 300 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
                          ) {
        return ((psa_status_t)-134);
    }
    ...
    if (key_type == ((psa_key_type_t) 0x2301) && key_bits == 128) {
    ...
    operation->block_length = ((((alg) & (((psa_algorithm_t) 0x7f000000) | ((psa_algorithm_t) 0x00800000))) == (((psa_algorithm_t) 0x04000000) | ((psa_algorithm_t) 0x00800000))) ? 1 :
                               (((key_type) & ((psa_key_type_t) 0x7000)) == ((psa_key_type_t) 0x2000) ? 1u << (((key_type) >> 8) & 7) : 0u));
    operation->iv_length = ((((key_type) & ((psa_key_type_t) 0x7000)) == ((psa_key_type_t) 0x2000) ? 1u << (((key_type) >> 8) & 7) : 0u) > 1 && ((alg) == ((psa_algorithm_t) 0x04c01000) || (alg) == ((psa_algorithm_t) 0x04c01100) || (alg) == ((psa_algorithm_t) 0x04c01200) || (alg) == ((psa_algorithm_t) 0x0440ff00) || (alg) == ((psa_algorithm_t) 0x04404000) || (alg) == ((psa_algorithm_t) 0x04404100)) ? (((key_type) & ((psa_key_type_t) 0x7000)) == ((psa_key_type_t) 0x2000) ? 1u << (((key_type) >> 8) & 7) : 0u) : (key_type) == ((psa_key_type_t) 0x2004) && (alg) == ((psa_algorithm_t) 0x04800100) ? 12u : (alg) == ((psa_algorithm_t) 0x04c01300) ? 13u : 0u);
...
# 417 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
    ...
    uint8_t *output, size_t output_size, size_t *output_length)
{
    ...
    if (operation->alg == ((psa_algorithm_t) 0x04404400)) {
...
# 564 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/psa_crypto_cipher.c"
    ...
    if (operation->ctx.cipher.unprocessed_len != 0) {
        if (operation->alg == ((psa_algorithm_t) 0x04404400) ||
            operation->alg == ((psa_algorithm_t) 0x04404000)) {
...
{
    psa_status_t status = ((psa_status_t)-151);
    mbedtls_psa_cipher_operation_t operation = { 0, 0, 0, { 0 } };
