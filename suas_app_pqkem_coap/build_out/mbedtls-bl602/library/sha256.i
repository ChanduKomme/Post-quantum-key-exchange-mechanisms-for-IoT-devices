# 0 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
# 1 "/home/chandu/sdk/bl602_iot_sdk/customer_app/suas_app_pqkem_coap/build_out/mbedtls-bl602//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
# 51 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
...
# 112 "/home/chandu/sdk/bl602_iot_sdk/toolchain/compiler/riscv32-unknown-elf/include/string.h" 3
...
# 172 "/home/chandu/sdk/bl602_iot_sdk/toolchain/compiler/riscv32-unknown-elf/include/string.h" 3
...
# 52 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 2



# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha256.h" 1
# 15 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha256.h"
# 1 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/private_access.h" 1
# 16 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/include/mbedtls/sha256.h" 2
...
# 56 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 2
...
# 57 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 2
...
# 58 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 2
...
# 62 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 2
# 225 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
void mbedtls_sha256_init(mbedtls_sha256_context *ctx)
{
...
{
    if (ctx == 
# 232 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 3 4
              ((void *)0)
# 232 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
                  ) {
        return;
    }
...
# 264 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
# 492 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
int mbedtls_internal_sha256_process(mbedtls_sha256_context *ctx,
                                      const unsigned char data[64])
{
    struct {
    ...
    for (i = 0; i < 64; i++) {
        if (i < 16) {
            local.W[i] = ((0) ? mbedtls_get_unaligned_uint32((data) + (4 * i)) : __builtin_bswap32(mbedtls_get_unaligned_uint32((data) + (4 * i))) );
        } else {
            ( local.W[i] = (((((local.W[(i) - 2]) & 0xFFFFFFFF) >> (17)) | ((local.W[(i) - 2]) << (32 - (17)))) ^ ((((local.W[(i) - 2]) & 0xFFFFFFFF) >> (19)) | ((local.W[(i) - 2]) << (32 - (19)))) ^ (((local.W[(i) - 2]) & 0xFFFFFFFF) >> (10))) + local.W[(i) - 7] + (((((local.W[(i) - 15]) & 0xFFFFFFFF) >> (7)) | ((local.W[(i) - 15]) << (32 - (7)))) ^ ((((local.W[(i) - 15]) & 0xFFFFFFFF) >> (18)) | ((local.W[(i) - 15]) << (32 - (18)))) ^ (((local.W[(i) - 15]) & 0xFFFFFFFF) >> (3))) + local.W[(i) - 16] );
        }

        do { local.temp1 = (local.A[7]) + (((((local.A[4]) & 0xFFFFFFFF) >> (6)) | ((local.A[4]) << (32 - (6)))) ^ ((((local.A[4]) & 0xFFFFFFFF) >> (11)) | ((local.A[4]) << (32 - (11)))) ^ ((((local.A[4]) & 0xFFFFFFFF) >> (25)) | ((local.A[4]) << (32 - (25))))) + (((local.A[6])) ^ (((local.A[4])) & (((local.A[5])) ^ ((local.A[6]))))) + (K[i]) + (local.W[i]); local.temp2 = (((((local.A[0]) & 0xFFFFFFFF) >> (2)) | ((local.A[0]) << (32 - (2)))) ^ ((((local.A[0]) & 0xFFFFFFFF) >> (13)) | ((local.A[0]) << (32 - (13)))) ^ ((((local.A[0]) & 0xFFFFFFFF) >> (22)) | ((local.A[0]) << (32 - (22))))) + ((((local.A[0])) & ((local.A[1]))) | (((local.A[2])) & (((local.A[0])) | ((local.A[1]))))); (local.A[3]) += local.temp1; (local.A[7]) = local.temp1 + local.temp2; } while (0)
                                                               ;
...
# 567 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
    for (i = 0; i < 8; i++) {
...
# 645 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
int mbedtls_sha256_update(mbedtls_sha256_context *ctx,
                          const unsigned char *input,
                          size_t ilen)
{
                          ...
                          unsigned char *output)
{
    ...
    { if (0) { mbedtls_put_unaligned_uint32((output) + (20), (uint32_t) (ctx->state[5])); } else { mbedtls_put_unaligned_uint32((output) + (20), __builtin_bswap32((uint32_t) (ctx->state[5]))); } };
    { if (0) { mbedtls_put_unaligned_uint32((output) + (24), (uint32_t) (ctx->state[6])); } else { mbedtls_put_unaligned_uint32((output) + (24), __builtin_bswap32((uint32_t) (ctx->state[6]))); } };


    truncated = ctx->is224;

    if (!truncated) {
        { if (0) { mbedtls_put_unaligned_uint32((output) + (28), (uint32_t) (ctx->state[7])); } else { mbedtls_put_unaligned_uint32((output) + (28), __builtin_bswap32((uint32_t) (ctx->state[7]))); } };
    }
...
# 795 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
...
static int mbedtls_sha256_common_self_test(int verbose, int is224)
{
    ...
    if (
# 894 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c" 3 4
       ((void *)0) 
# 894 "/home/chandu/sdk/bl602_iot_sdk/components/security/mbedtls-bl602/library/sha256.c"
            == buf) {
        if (verbose != 0) {
